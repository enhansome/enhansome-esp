...
* [MicroPython](https://github.com/micropython/micropython/) ⭐ 22,036 | 🐛 1,533 | 🌐 C | 📅 2026-09-02 - An implemention of Python3 for the ESP8266 and 32.
* [RT-Thread](https://github.com/RT-Thread/rt-thread) ⭐ 12,185 | 🐛 496 | 🌐 C | 📅 2026-09-01 - Chinese open source firmware available for the ESP32.
...
* [Arduino Core/32](https://github.com/espressif/arduino-esp32) ⭐ 17,309 | 🐛 157 | 🌐 C++ | 📅 2026-09-02 - The other Arduino core for the ESP32.
* [Arduino Core/8266](https://github.com/esp8266/arduino) ⭐ 16,673 | 🐛 404 | 🌐 C++ | 📅 2026-08-27 - The Arduino core for the ESP8266.
* [PlatformIO](https://github.com/platformio/platformio-core) ⭐ 9,432 | 🐛 313 | 🌐 Python | 📅 2026-08-28 - Cross Platform IDE and Debugger that supports both the ESP32 and ESP8266.
* [ESPTool](https://github.com/espressif/esptool) ⭐ 6,465 | 🐛 14 | 🌐 Python | 📅 2026-08-31 - Espressif's command line tool for bootloader comms in both ESP's.
...
* [LuaNode](https://github.com/Nicholas3388/LuaNode) ⭐ 1,331 | 🐛 36 | 🌐 C | 📅 2024-05-30 - A lua-only SDK for 32/8266.
...
* [OpenMQTTGateway](https://github.com/1technophile/OpenMQTTGateway) ⭐ 4,082 | 🐛 47 | 🌐 C++ | 📅 2026-09-01 - An implementation of a multiprotocol MQTT gateway for both ESP's among other devices.
* [ESPEasy](https://github.com/letscontrolit/ESPEasy) ⭐ 3,592 | 🐛 384 | 🌐 C++ | 📅 2026-09-01 - Easily turn ESP modules into multifunction sensor devices for home automation systems.
...
* [CanAirIO](https://github.com/kike-canaries/canairio_firmware#canairio-firmware) ⭐ 128 | 🐛 29 | 🌐 C++ | 📅 2026-09-01 - Citizen science project that uses mobile and fixed stations to measure air quality with ESP32 and smartphones.
...
* [ESP8266 Deauther](https://github.com/spacehuhn/esp8266_deauther) ⭐ 14,950 | 🐛 99 | 🌐 C | 📅 2024-08-14 - A very cool pseudojammer (deauther) of Wifi networks that uses the ESP8266.
* [ESP32Marauder](https://github.com/justcallmekoko/ESP32Marauder) ⭐ 12,195 | 🐛 333 | 🌐 C++ | 📅 2026-08-29 - An integrated suite of offensive and defensive tools for WiFi and Bluetooth.
* [WiFiDuck](https://github.com/spacehuhn/WiFiDuck) ⭐ 3,283 | 🐛 22 | 🌐 C++ | 📅 2023-06-02 - A wireless-enabled keystroke injector, analogous, but even more awesome than the Rubber Ducky.
...
* [DeauthDetector](https://github.com/spacehuhn/DeauthDetector) ⭐ 973 | 🐛 19 | 🌐 C++ | 📅 2023-08-28 - A small device that shines a light if it detects a WiFi deauth attack. Made by the same guy as the last six projects.
...
* [ESP32-Paxcounter](https://github.com/cyberman54/ESP32-Paxcounter#esp32-paxcounter) ⭐ 2,087 | 🐛 18 | 🌐 C++ | 📅 2026-08-12 - Wifi & Bluetooth driven, LoRaWAN enabled, battery powered mini Paxcounter built on cheap ESP32 LoRa IoT boards.
...
* [Squeezelite-esp32](https://github.com/sle118/squeezelite-esp32) ⭐ 2,185 | 🐛 91 | 🌐 C | 📅 2026-07-30 - Streaming audio receiver with multi-room sync, AirPlay, Bluetooth, hardware buttons, display and more.
* [ESP32-Radio](https://github.com/Edzelf/ESP32-Radio) ⭐ 1,068 | 🐛 343 | 🌐 C++ | 📅 2024-10-21 - Internet radio based on ESP32, VS1053 and a TFT screen.
* [PedalinoMini](https://github.com/alf45tar/PedalinoMini) ⭐ 615 | 🐛 47 | 🌐 Python | 📅 2026-05-04 - A wireless MIDI pedal controller for guitarists, built with the ESP32.
* [ESPuino](https://github.com/biologist79/ESPuino) ⭐ 418 | 🐛 1 | 🌐 C++ | 📅 2026-09-02 - RFID-controlled music player powered by ESP32.
...
* [Knobby](https://github.com/quadule/knobby) ⭐ 214 | 🐛 1 | 🌐 C | 📅 2025-12-14 - A handheld Spotify remote that encourages you to explore unfamiliar music.
...
* [DroneBridge](https://github.com/DroneBridge/ESP32) ⭐ 1,079 | 🐛 6 | 🌐 C | 📅 2026-08-26 - An implementation of DroneBridge, a signal link for drones and UAV's on the ESP32.
* [SoftRF](https://github.com/lyusupov/SoftRF) ⭐ 1,010 | 🐛 0 | 🌐 C | 📅 2026-09-01 - A DIY aviation proximity awareness system that can be used in UAV projects.
* [Retro ESP32](https://github.com/retro-esp32/RetroESP32) ⭐ 725 | 🐛 21 | 🌐 C | 📅 2024-07-31 - An extremely cool launcher for the Odroid Go (with the ESP32), which allows emulating several retro consoles.
...
* [SmartSpin2k](https://github.com/doudar/SmartSpin2k) ⭐ 279 | 🐛 27 | 🌐 C++ | 📅 2026-09-01 - Transform your spin bike into a smart trainer with automatic resistance knob control in fitness apps like Zwift.
* [WLED](https://kno.wled.ge/) - Control many types of RGB(W) LED strips with an ESP8266 or ESP32 over WiFi.

## Libraries

* [Wasm3](https://github.com/wasm3/wasm3) ⭐ 8,013 | 🐛 20 | 🌐 C | 📅 2026-09-01 - A lightning fast WebAssembly interpreter designed for embedded devices, compatible with both ESP's.
* [IRremoteESP8266](https://github.com/markszabo/IRremoteESP8266) ⭐ 3,582 | 🐛 103 | 🌐 C++ | 📅 2026-08-23 - Emit and receive IR signals in the ESP8266.
* [ESPAudio](https://github.com/earlephilhower/ESP8266Audio) ⭐ 2,394 | 🐛 0 | 🌐 C | 📅 2026-08-02 - Library for playing a diverse range of audio formats in the ESP8266/ESP32.
...
* [HomeSpan](https://github.com/HomeSpan/HomeSpan) ⭐ 2,155 | 🐛 9 | 🌐 C++ | 📅 2026-09-01 - A robust and extremely easy-to-use Arduino library for creating your own ESP32-based HomeKit devices.
...
* [LedFx](https://github.com/LedFx/LedFx) ⭐ 2,036 | 🐛 17 | 🌐 Python | 📅 2026-08-31 - A library for using audio input to create realtime light shows. LedFx can control multiple devices and works great with cheap ESP8266 nodes.
* [ESP32-audioI2S](https://github.com/schreibfaul1/ESP32-audioI2S) ⭐ 1,684 | 🐛 15 | 🌐 C | 📅 2026-08-31 - Plays mp3, m4a and wav files from SD card or stream via I2S interface.
* [ESP-Dash](https://github.com/ayushsharma82/ESP-DASH) ⭐ 1,399 | 🐛 0 | 🌐 C++ | 📅 2025-11-22 - Beautiful and fast framework for creating remote dashboards in the 8266/32. No internet required.
...
* [GUIslice](https://github.com/ImpulseAdventure/GUIslice) ⭐ 1,362 | 🐛 48 | 🌐 C | 📅 2026-07-14 - A drag and drop GUI framework for several devices and screen controllers. Compatible with 8266 and 32.
