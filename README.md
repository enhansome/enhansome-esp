...
* [MicroPython](https://github.com/micropython/micropython/) ⭐ 22,062 | 🐛 1,525 | 🌐 C | 📅 2026-09-11 - An implemention of Python3 for the ESP8266 and 32.
* [RT-Thread](https://github.com/RT-Thread/rt-thread) ⭐ 12,217 | 🐛 489 | 🌐 C | 📅 2026-09-14 - Chinese open source firmware available for the ESP32.
...
* [Arduino Core/32](https://github.com/espressif/arduino-esp32) ⭐ 17,377 | 🐛 176 | 🌐 C++ | 📅 2026-09-14 - The other Arduino core for the ESP32.
* [Arduino Core/8266](https://github.com/esp8266/arduino) ⭐ 16,681 | 🐛 405 | 🌐 C++ | 📅 2026-08-27 - The Arduino core for the ESP8266.
* [PlatformIO](https://github.com/platformio/platformio-core) ⭐ 9,457 | 🐛 280 | 🌐 Python | 📅 2026-09-11 - Cross Platform IDE and Debugger that supports both the ESP32 and ESP8266.
* [ESPTool](https://github.com/espressif/esptool) ⭐ 6,476 | 🐛 15 | 🌐 Python | 📅 2026-09-10 - Espressif's command line tool for bootloader comms in both ESP's.
...
* [ESPEasy](https://github.com/letscontrolit/ESPEasy) ⭐ 3,603 | 🐛 389 | 🌐 C++ | 📅 2026-09-11 - Easily turn ESP modules into multifunction sensor devices for home automation systems.
...
* [ESP32Marauder](https://github.com/justcallmekoko/ESP32Marauder) ⭐ 12,344 | 🐛 330 | 🌐 C++ | 📅 2026-09-12 - An integrated suite of offensive and defensive tools for WiFi and Bluetooth.
...
* [ESPuino](https://github.com/biologist79/ESPuino) ⭐ 422 | 🐛 1 | 🌐 C++ | 📅 2026-09-13 - RFID-controlled music player powered by ESP32.
...
* [SoftRF](https://github.com/lyusupov/SoftRF) ⭐ 1,021 | 🐛 0 | 🌐 C | 📅 2026-09-07 - A DIY aviation proximity awareness system that can be used in UAV projects.
...
* [Wasm3](https://github.com/wasm3/wasm3) ⭐ 8,026 | 🐛 18 | 🌐 C | 📅 2026-09-14 - A lightning fast WebAssembly interpreter designed for embedded devices, compatible with both ESP's.
* [IRremoteESP8266](https://github.com/markszabo/IRremoteESP8266) ⭐ 3,600 | 🐛 104 | 🌐 C++ | 📅 2026-08-23 - Emit and receive IR signals in the ESP8266.
...
* [HomeSpan](https://github.com/HomeSpan/HomeSpan) ⭐ 2,162 | 🐛 9 | 🌐 C++ | 📅 2026-09-14 - A robust and extremely easy-to-use Arduino library for creating your own ESP32-based HomeKit devices.
