...
* [OpenMQTTGateway](https://github.com/1technophile/OpenMQTTGateway) ⭐ 4,082 | 🐛 50 | 🌐 C++ | 📅 2026-08-26 - An implementation of a multiprotocol MQTT gateway for both ESP's among other devices.
* [ESPEasy](https://github.com/letscontrolit/ESPEasy) ⭐ 3,583 | 🐛 379 | 🌐 C++ | 📅 2026-08-27 - Easily turn ESP modules into multifunction sensor devices for home automation systems.
...
* [Squeezelite-esp32](https://github.com/sle118/squeezelite-esp32) ⭐ 2,173 | 🐛 89 | 🌐 C | 📅 2026-07-30 - Streaming audio receiver with multi-room sync, AirPlay, Bluetooth, hardware buttons, display and more.
* [ESP32-Radio](https://github.com/Edzelf/ESP32-Radio) ⭐ 1,066 | 🐛 343 | 🌐 C++ | 📅 2024-10-21 - Internet radio based on ESP32, VS1053 and a TFT screen.
...
* [ESPuino](https://github.com/biologist79/ESPuino) ⭐ 417 | 🐛 4 | 🌐 C++ | 📅 2026-08-27 - RFID-controlled music player powered by ESP32.
...
* [Wasm3](https://github.com/wasm3/wasm3) ⭐ 8,002 | 🐛 29 | 🌐 C | 📅 2026-08-27 - A lightning fast WebAssembly interpreter designed for embedded devices, compatible with both ESP's.
...
* [ESP32-audioI2S](https://github.com/schreibfaul1/ESP32-audioI2S) ⭐ 1,683 | 🐛 32 | 🌐 C | 📅 2026-08-26 - Plays mp3, m4a and wav files from SD card or stream via I2S interface.
...
* [CanAirIO SensorLib](https://github.com/kike-canaries/canairio_sensorlib#canairio-air-quality-sensors-library) ⭐ 45 | 🐛 12 | 🌐 C++ | 📅 2026-08-27 - ESP32/8266 library with auto-configuration of multiple PM2.5, CO2 and environment sensors.
