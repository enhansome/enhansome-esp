...
* [MicroPython](https://github.com/micropython/micropython/) ⭐ 22,054 | 🐛 1,526 | 🌐 C | 📅 2026-09-09 - An implemention of Python3 for the ESP8266 and 32.
* [RT-Thread](https://github.com/RT-Thread/rt-thread) ⭐ 12,207 | 🐛 490 | 🌐 C | 📅 2026-09-11 - Chinese open source firmware available for the ESP32.
...
* [Arduino Core/32](https://github.com/espressif/arduino-esp32) ⭐ 17,363 | 🐛 171 | 🌐 C++ | 📅 2026-09-11 - The other Arduino core for the ESP32.
* [Arduino Core/8266](https://github.com/esp8266/arduino) ⭐ 16,679 | 🐛 405 | 🌐 C++ | 📅 2026-08-27 - The Arduino core for the ESP8266.
* [PlatformIO](https://github.com/platformio/platformio-core) ⭐ 9,450 | 🐛 278 | 🌐 Python | 📅 2026-09-10 - Cross Platform IDE and Debugger that supports both the ESP32 and ESP8266.
* [ESPTool](https://github.com/espressif/esptool) ⭐ 6,470 | 🐛 14 | 🌐 Python | 📅 2026-09-10 - Espressif's command line tool for bootloader comms in both ESP's.
...
* [OpenMQTTGateway](https://github.com/1technophile/OpenMQTTGateway) ⭐ 4,091 | 🐛 47 | 🌐 C++ | 📅 2026-09-08 - An implementation of a multiprotocol MQTT gateway for both ESP's among other devices.
* [ESPEasy](https://github.com/letscontrolit/ESPEasy) ⭐ 3,602 | 🐛 388 | 🌐 C++ | 📅 2026-09-01 - Easily turn ESP modules into multifunction sensor devices for home automation systems.
...
* [ESP32Marauder](https://github.com/justcallmekoko/ESP32Marauder) ⭐ 12,314 | 🐛 328 | 🌐 C++ | 📅 2026-09-10 - An integrated suite of offensive and defensive tools for WiFi and Bluetooth.
* [WiFiDuck](https://github.com/spacehuhn/WiFiDuck) ⭐ 3,296 | 🐛 22 | 🌐 C++ | 📅 2023-06-02 - A wireless-enabled keystroke injector, analogous, but even more awesome than the Rubber Ducky.
...
* [Squeezelite-esp32](https://github.com/sle118/squeezelite-esp32) ⭐ 2,190 | 🐛 92 | 🌐 C | 📅 2026-07-30 - Streaming audio receiver with multi-room sync, AirPlay, Bluetooth, hardware buttons, display and more.
...
* [PedalinoMini](https://github.com/alf45tar/PedalinoMini) ⭐ 616 | 🐛 48 | 🌐 Python | 📅 2026-05-04 - A wireless MIDI pedal controller for guitarists, built with the ESP32.
...
* [Wasm3](https://github.com/wasm3/wasm3) ⭐ 8,024 | 🐛 18 | 🌐 C | 📅 2026-09-10 - A lightning fast WebAssembly interpreter designed for embedded devices, compatible with both ESP's.
* [IRremoteESP8266](https://github.com/markszabo/IRremoteESP8266) ⭐ 3,594 | 🐛 103 | 🌐 C++ | 📅 2026-08-23 - Emit and receive IR signals in the ESP8266.
* [ESPAudio](https://github.com/earlephilhower/ESP8266Audio) ⭐ 2,396 | 🐛 0 | 🌐 C | 📅 2026-08-02 - Library for playing a diverse range of audio formats in the ESP8266/ESP32.
...
* [LedFx](https://github.com/LedFx/LedFx) ⭐ 2,045 | 🐛 16 | 🌐 Python | 📅 2026-09-07 - A library for using audio input to create realtime light shows. LedFx can control multiple devices and works great with cheap ESP8266 nodes.
* [ESP32-audioI2S](https://github.com/schreibfaul1/ESP32-audioI2S) ⭐ 1,691 | 🐛 17 | 🌐 C | 📅 2026-09-10 - Plays mp3, m4a and wav files from SD card or stream via I2S interface.
