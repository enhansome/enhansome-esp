...
* [MicroPython](https://github.com/micropython/micropython/) ⭐ 22,060 | 🐛 1,524 | 🌐 C | 📅 2026-09-11 - An implemention of Python3 for the ESP8266 and 32.
* [RT-Thread](https://github.com/RT-Thread/rt-thread) ⭐ 12,214 | 🐛 495 | 🌐 C | 📅 2026-09-11 - Chinese open source firmware available for the ESP32.
* [NodeMCU](https://github.com/nodemcu/nodemcu-firmware) ⭐ 7,944 | 🐛 119 | 🌐 C | 📅 2026-06-07 - An eLua-based firmware for the ESP8266.
* [MongooseOS](https://github.com/cesanta/mongoose-os) ⭐ 2,666 | 🐛 97 | 🌐 C | 📅 2026-07-26 - An IoT specific firmware, with both C and JS. Available for the ESP32/8266.
* [ESP3D](https://github.com/luc-github/ESP3D) ⭐ 1,996 | 🐛 6 | 🌐 C | 📅 2026-07-22 - An experimental firmware for 3D Printers, both the ESP32 and 8266.
...
* [Arduino Core/32](https://github.com/espressif/arduino-esp32) ⭐ 17,373 | 🐛 175 | 🌐 C++ | 📅 2026-09-13 - The other Arduino core for the ESP32.
* [Arduino Core/8266](https://github.com/esp8266/arduino) ⭐ 16,682 | 🐛 405 | 🌐 C++ | 📅 2026-08-27 - The Arduino core for the ESP8266.
* [PlatformIO](https://github.com/platformio/platformio-core) ⭐ 9,452 | 🐛 278 | 🌐 Python | 📅 2026-09-11 - Cross Platform IDE and Debugger that supports both the ESP32 and ESP8266.
* [ESPTool](https://github.com/espressif/esptool) ⭐ 6,476 | 🐛 14 | 🌐 Python | 📅 2026-09-10 - Espressif's command line tool for bootloader comms in both ESP's.
...
* [Arduino FS Plugin](https://github.com/esp8266/arduino-esp8266fs-plugin) ⭐ 736 | 🐛 57 | 🌐 Java | 📅 2022-11-30 - An Arduino plugin for filesystem uploads in the 8266.
...
* [OpenMQTTGateway](https://github.com/1technophile/OpenMQTTGateway) ⭐ 4,093 | 🐛 49 | 🌐 C++ | 📅 2026-09-13 - An implementation of a multiprotocol MQTT gateway for both ESP's among other devices.
* [ESPEasy](https://github.com/letscontrolit/ESPEasy) ⭐ 3,602 | 🐛 389 | 🌐 C++ | 📅 2026-09-11 - Easily turn ESP modules into multifunction sensor devices for home automation systems.
...
* [ESP8266 Deauther](https://github.com/spacehuhn/esp8266_deauther) ⭐ 14,970 | 🐛 99 | 🌐 C | 📅 2024-08-14 - A very cool pseudojammer (deauther) of Wifi networks that uses the ESP8266.
* [ESP32Marauder](https://github.com/justcallmekoko/ESP32Marauder) ⭐ 12,331 | 🐛 330 | 🌐 C++ | 📅 2026-09-12 - An integrated suite of offensive and defensive tools for WiFi and Bluetooth.
* [WiFiDuck](https://github.com/spacehuhn/WiFiDuck) ⭐ 3,303 | 🐛 22 | 🌐 C++ | 📅 2023-06-02 - A wireless-enabled keystroke injector, analogous, but even more awesome than the Rubber Ducky.
* [ESP8266 Beacon Spam](https://github.com/spacehuhn/esp8266_beaconSpam) ⭐ 1,369 | 🐛 25 | 🌐 C++ | 📅 2024-08-08 - Want to confuse people? This device creates hundreds of fake WiFi networks.
* [DeauthDetector](https://github.com/spacehuhn/DeauthDetector) ⭐ 976 | 🐛 19 | 🌐 C++ | 📅 2023-08-28 - A small device that shines a light if it detects a WiFi deauth attack. Made by the same guy as the last six projects.
...
* [PacketMonitor](https://github.com/spacehuhn/PacketMonitor32) ⭐ 404 | 🐛 7 | 🌐 C++ | 📅 2020-11-20 - A beautiful OLED monitor for packet activity in a WiFi channel. Two versions for each ESP.
...
* [ESP32-Paxcounter](https://github.com/cyberman54/ESP32-Paxcounter#esp32-paxcounter) ⭐ 2,091 | 🐛 18 | 🌐 C++ | 📅 2026-08-12 - Wifi & Bluetooth driven, LoRaWAN enabled, battery powered mini Paxcounter built on cheap ESP32 LoRa IoT boards.
...
* [Squeezelite-esp32](https://github.com/sle118/squeezelite-esp32) ⭐ 2,192 | 🐛 92 | 🌐 C | 📅 2026-07-30 - Streaming audio receiver with multi-room sync, AirPlay, Bluetooth, hardware buttons, display and more.
...
* [PedalinoMini](https://github.com/alf45tar/PedalinoMini) ⭐ 617 | 🐛 48 | 🌐 Python | 📅 2026-05-04 - A wireless MIDI pedal controller for guitarists, built with the ESP32.
* [ESPuino](https://github.com/biologist79/ESPuino) ⭐ 422 | 🐛 1 | 🌐 C++ | 📅 2026-09-09 - RFID-controlled music player powered by ESP32.
...
* [DroneBridge](https://github.com/DroneBridge/ESP32) ⭐ 1,092 | 🐛 7 | 🌐 C | 📅 2026-09-12 - An implementation of DroneBridge, a signal link for drones and UAV's on the ESP32.
* [SoftRF](https://github.com/lyusupov/SoftRF) ⭐ 1,019 | 🐛 0 | 🌐 C | 📅 2026-09-07 - A DIY aviation proximity awareness system that can be used in UAV projects.
* [Retro ESP32](https://github.com/retro-esp32/RetroESP32) ⭐ 730 | 🐛 21 | 🌐 C | 📅 2024-07-31 - An extremely cool launcher for the Odroid Go (with the ESP32), which allows emulating several retro consoles.
...
* [E-TKT](https://github.com/andreisperid/E-TKT) ⭐ 475 | 🐛 20 | 🌐 C++ | 📅 2023-05-04 - An ESP32 powered DIY label maker that mixes both old fashioned and contemporary technology.
...
* [SmartSpin2k](https://github.com/doudar/SmartSpin2k) ⭐ 280 | 🐛 25 | 🌐 C++ | 📅 2026-09-12 - Transform your spin bike into a smart trainer with automatic resistance knob control in fitness apps like Zwift.
* [WLED](https://kno.wled.ge/) - Control many types of RGB(W) LED strips with an ESP8266 or ESP32 over WiFi.

## Libraries

* [Wasm3](https://github.com/wasm3/wasm3) ⭐ 8,025 | 🐛 18 | 🌐 C | 📅 2026-09-12 - A lightning fast WebAssembly interpreter designed for embedded devices, compatible with both ESP's.
* [IRremoteESP8266](https://github.com/markszabo/IRremoteESP8266) ⭐ 3,598 | 🐛 104 | 🌐 C++ | 📅 2026-08-23 - Emit and receive IR signals in the ESP8266.
...
* [HomeSpan](https://github.com/HomeSpan/HomeSpan) ⭐ 2,161 | 🐛 9 | 🌐 C++ | 📅 2026-09-13 - A robust and extremely easy-to-use Arduino library for creating your own ESP32-based HomeKit devices.
* [mJS](https://github.com/cesanta/mjs) ⭐ 2,056 | 🐛 196 | 🌐 C | 📅 2026-03-16 - A lightweight and restricted JS engine that is used by MongooseOS, compatible on the 32 and 8266.
* [LedFx](https://github.com/LedFx/LedFx) ⭐ 2,048 | 🐛 16 | 🌐 Python | 📅 2026-09-07 - A library for using audio input to create realtime light shows. LedFx can control multiple devices and works great with cheap ESP8266 nodes.
* [ESP32-audioI2S](https://github.com/schreibfaul1/ESP32-audioI2S) ⭐ 1,693 | 🐛 13 | 🌐 C | 📅 2026-09-10 - Plays mp3, m4a and wav files from SD card or stream via I2S interface.
...
* [ESPUI](https://github.com/s00500/ESPUI) ⭐ 1,126 | 🐛 53 | 🌐 C++ | 📅 2026-04-30 - A simply library for making interactive web interfaces for both ESP's.
...
* [TFTLibrary](https://github.com/loboris/ESP32_TFT_library) ⭐ 659 | 🐛 65 | 🌐 C | 📅 2024-06-19 - TFT compatibility for the ESP32.
* [WiFiESP](https://github.com/bportaluri/WiFiEsp) ⭐ 572 | 🐛 134 | 🌐 C++ | 📅 2024-03-26 - Arduino library for Wifi management, client/server for 8266 board.
