...
* [MicroPython](https://github.com/micropython/micropython/) ⭐ 21,986 | 🐛 1,545 | 🌐 C | 📅 2026-08-13 - An implemention of Python3 for the ESP8266 and 32.
* [RT-Thread](https://github.com/RT-Thread/rt-thread) ⭐ 12,147 | 🐛 484 | 🌐 C | 📅 2026-08-13 - Chinese open source firmware available for the ESP32.
* [NodeMCU](https://github.com/nodemcu/nodemcu-firmware) ⭐ 7,939 | 🐛 119 | 🌐 C | 📅 2026-06-07 - An eLua-based firmware for the ESP8266.
...
* [ESP3D](https://github.com/luc-github/ESP3D) ⭐ 1,988 | 🐛 5 | 🌐 C | 📅 2026-07-22 - An experimental firmware for 3D Printers, both the ESP32 and 8266.
...
* [Arduino Core/32](https://github.com/espressif/arduino-esp32) ⭐ 17,225 | 🐛 163 | 🌐 C++ | 📅 2026-08-13 - The other Arduino core for the ESP32.
* [Arduino Core/8266](https://github.com/esp8266/arduino) ⭐ 16,663 | 🐛 405 | 🌐 C++ | 📅 2026-07-29 - The Arduino core for the ESP8266.
* [PlatformIO](https://github.com/platformio/platformio-core) ⭐ 9,398 | 🐛 315 | 🌐 Python | 📅 2026-08-11 - Cross Platform IDE and Debugger that supports both the ESP32 and ESP8266.
* [ESPTool](https://github.com/espressif/esptool) ⭐ 6,438 | 🐛 13 | 🌐 Python | 📅 2026-08-10 - Espressif's command line tool for bootloader comms in both ESP's.
...
* [OpenMQTTGateway](https://github.com/1technophile/OpenMQTTGateway) ⭐ 4,074 | 🐛 50 | 🌐 C++ | 📅 2026-08-10 - An implementation of a multiprotocol MQTT gateway for both ESP's among other devices.
* [ESPEasy](https://github.com/letscontrolit/ESPEasy) ⭐ 3,553 | 🐛 385 | 🌐 C++ | 📅 2026-08-08 - Easily turn ESP modules into multifunction sensor devices for home automation systems.
...
* [HomePoint](https://github.com/sieren/Homepoint) ⭐ 658 | 🐛 29 | 🌐 C | 📅 2022-08-04 - Control MQTT/HomeKit smart home devices from an ESP32-powered screen.
...
* [CanAirIO](https://github.com/kike-canaries/canairio_firmware#canairio-firmware) ⭐ 129 | 🐛 31 | 🌐 C++ | 📅 2026-08-11 - Citizen science project that uses mobile and fixed stations to measure air quality with ESP32 and smartphones.
...
* [ESP8266 Deauther](https://github.com/spacehuhn/esp8266_deauther) ⭐ 14,914 | 🐛 99 | 🌐 C | 📅 2024-08-14 - A very cool pseudojammer (deauther) of Wifi networks that uses the ESP8266.
* [ESP32Marauder](https://github.com/justcallmekoko/ESP32Marauder) ⭐ 11,938 | 🐛 320 | 🌐 C++ | 📅 2026-08-12 - An integrated suite of offensive and defensive tools for WiFi and Bluetooth.
* [WiFiDuck](https://github.com/spacehuhn/WiFiDuck) ⭐ 3,119 | 🐛 22 | 🌐 C++ | 📅 2023-06-02 - A wireless-enabled keystroke injector, analogous, but even more awesome than the Rubber Ducky.
...
* [ESP32-Paxcounter](https://github.com/cyberman54/ESP32-Paxcounter#esp32-paxcounter) ⭐ 2,079 | 🐛 18 | 🌐 C++ | 📅 2026-08-12 - Wifi & Bluetooth driven, LoRaWAN enabled, battery powered mini Paxcounter built on cheap ESP32 LoRa IoT boards.
* [Disaster Radio](https://disaster.radio/) - A disaster-resilient communications network powered by the sun.

### Music and Audio

* [Squeezelite-esp32](https://github.com/sle118/squeezelite-esp32) ⭐ 2,151 | 🐛 88 | 🌐 C | 📅 2026-07-30 - Streaming audio receiver with multi-room sync, AirPlay, Bluetooth, hardware buttons, display and more.
...
* [ESPuino](https://github.com/biologist79/ESPuino) ⭐ 416 | 🐛 9 | 🌐 C++ | 📅 2026-08-11 - RFID-controlled music player powered by ESP32.
...
* [SoftRF](https://github.com/lyusupov/SoftRF) ⭐ 999 | 🐛 0 | 🌐 C | 📅 2026-08-12 - A DIY aviation proximity awareness system that can be used in UAV projects.
* [DroneBridge](https://github.com/DroneBridge/ESP32) ⭐ 999 | 🐛 8 | 🌐 C | 📅 2026-08-12 - An implementation of DroneBridge, a signal link for drones and UAV's on the ESP32.
...
* [E-TKT](https://github.com/andreisperid/E-TKT) ⭐ 471 | 🐛 20 | 🌐 C++ | 📅 2023-05-04 - An ESP32 powered DIY label maker that mixes both old fashioned and contemporary technology.
...
* [SmartSpin2k](https://github.com/doudar/SmartSpin2k) ⭐ 277 | 🐛 27 | 🌐 C++ | 📅 2026-08-13 - Transform your spin bike into a smart trainer with automatic resistance knob control in fitness apps like Zwift.
...
* [IRremoteESP8266](https://github.com/markszabo/IRremoteESP8266) ⭐ 3,565 | 🐛 102 | 🌐 C++ | 📅 2026-08-02 - Emit and receive IR signals in the ESP8266.
* [ESPAudio](https://github.com/earlephilhower/ESP8266Audio) ⭐ 2,385 | 🐛 0 | 🌐 C | 📅 2026-08-02 - Library for playing a diverse range of audio formats in the ESP8266/ESP32.
...
* [LedFx](https://github.com/LedFx/LedFx) ⭐ 2,017 | 🐛 16 | 🌐 Python | 📅 2026-08-10 - A library for using audio input to create realtime light shows. LedFx can control multiple devices and works great with cheap ESP8266 nodes.
* [ESP32-audioI2S](https://github.com/schreibfaul1/ESP32-audioI2S) ⭐ 1,663 | 🐛 33 | 🌐 C | 📅 2026-08-12 - Plays mp3, m4a and wav files from SD card or stream via I2S interface.
* [ESP-Dash](https://github.com/ayushsharma82/ESP-DASH) ⭐ 1,395 | 🐛 0 | 🌐 C++ | 📅 2025-11-22 - Beautiful and fast framework for creating remote dashboards in the 8266/32. No internet required.
...
* [GUIslice](https://github.com/ImpulseAdventure/GUIslice) ⭐ 1,359 | 🐛 48 | 🌐 C | 📅 2026-07-14 - A drag and drop GUI framework for several devices and screen controllers. Compatible with 8266 and 32.
...
* [CanAirIO SensorLib](https://github.com/kike-canaries/canairio_sensorlib#canairio-air-quality-sensors-library) ⭐ 45 | 🐛 12 | 🌐 C++ | 📅 2026-08-10 - ESP32/8266 library with auto-configuration of multiple PM2.5, CO2 and environment sensors.
