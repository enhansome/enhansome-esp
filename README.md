...
* [MicroPython](https://github.com/micropython/micropython/) ⭐ 22,054 | 🐛 1,525 | 🌐 C | 📅 2026-09-09 - An implemention of Python3 for the ESP8266 and 32.
* [RT-Thread](https://github.com/RT-Thread/rt-thread) ⭐ 12,207 | 🐛 494 | 🌐 C | 📅 2026-09-10 - Chinese open source firmware available for the ESP32.
...
* [ESP3D](https://github.com/luc-github/ESP3D) ⭐ 1,993 | 🐛 5 | 🌐 C | 📅 2026-07-22 - An experimental firmware for 3D Printers, both the ESP32 and 8266.
...
* [Arduino Core/32](https://github.com/espressif/arduino-esp32) ⭐ 17,359 | 🐛 172 | 🌐 C++ | 📅 2026-09-10 - The other Arduino core for the ESP32.
* [Arduino Core/8266](https://github.com/esp8266/arduino) ⭐ 16,679 | 🐛 405 | 🌐 C++ | 📅 2026-08-27 - The Arduino core for the ESP8266.
* [PlatformIO](https://github.com/platformio/platformio-core) ⭐ 9,451 | 🐛 278 | 🌐 Python | 📅 2026-09-07 - Cross Platform IDE and Debugger that supports both the ESP32 and ESP8266.
...
* [NodeMCU Flasher](https://github.com/nodemcu/nodemcu-flasher) ⭐ 2,217 | 🐛 47 | 🌐 Pascal | 📅 2017-08-08 - The official flashing tool for the NodeMCU OS.
...
* [OpenMQTTGateway](https://github.com/1technophile/OpenMQTTGateway) ⭐ 4,090 | 🐛 47 | 🌐 C++ | 📅 2026-09-08 - An implementation of a multiprotocol MQTT gateway for both ESP's among other devices.
...
* [ESP8266 Deauther](https://github.com/spacehuhn/esp8266_deauther) ⭐ 14,966 | 🐛 99 | 🌐 C | 📅 2024-08-14 - A very cool pseudojammer (deauther) of Wifi networks that uses the ESP8266.
* [ESP32Marauder](https://github.com/justcallmekoko/ESP32Marauder) ⭐ 12,290 | 🐛 328 | 🌐 C++ | 📅 2026-09-09 - An integrated suite of offensive and defensive tools for WiFi and Bluetooth.
...
* [Squeezelite-esp32](https://github.com/sle118/squeezelite-esp32) ⭐ 2,189 | 🐛 92 | 🌐 C | 📅 2026-07-30 - Streaming audio receiver with multi-room sync, AirPlay, Bluetooth, hardware buttons, display and more.
...
* [Retro ESP32](https://github.com/retro-esp32/RetroESP32) ⭐ 729 | 🐛 21 | 🌐 C | 📅 2024-07-31 - An extremely cool launcher for the Odroid Go (with the ESP32), which allows emulating several retro consoles.
...
* [SmartSpin2k](https://github.com/doudar/SmartSpin2k) ⭐ 280 | 🐛 25 | 🌐 C++ | 📅 2026-09-08 - Transform your spin bike into a smart trainer with automatic resistance knob control in fitness apps like Zwift.
* [WLED](https://kno.wled.ge/) - Control many types of RGB(W) LED strips with an ESP8266 or ESP32 over WiFi.

## Libraries

* [Wasm3](https://github.com/wasm3/wasm3) ⭐ 8,025 | 🐛 18 | 🌐 C | 📅 2026-09-09 - A lightning fast WebAssembly interpreter designed for embedded devices, compatible with both ESP's.
...
* [LedFx](https://github.com/LedFx/LedFx) ⭐ 2,044 | 🐛 16 | 🌐 Python | 📅 2026-09-07 - A library for using audio input to create realtime light shows. LedFx can control multiple devices and works great with cheap ESP8266 nodes.
* [ESP32-audioI2S](https://github.com/schreibfaul1/ESP32-audioI2S) ⭐ 1,691 | 🐛 17 | 🌐 C | 📅 2026-09-07 - Plays mp3, m4a and wav files from SD card or stream via I2S interface.
