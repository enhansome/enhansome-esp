...
* [MicroPython](https://github.com/micropython/micropython/) ⭐ 22,016 | 🐛 1,534 | 🌐 C | 📅 2026-08-28 - An implemention of Python3 for the ESP8266 and 32.
* [RT-Thread](https://github.com/RT-Thread/rt-thread) ⭐ 12,173 | 🐛 497 | 🌐 C | 📅 2026-08-28 - Chinese open source firmware available for the ESP32.
...
* [Arduino Core/32](https://github.com/espressif/arduino-esp32) ⭐ 17,292 | 🐛 149 | 🌐 C++ | 📅 2026-08-28 - The other Arduino core for the ESP32.
* [Arduino Core/8266](https://github.com/esp8266/arduino) ⭐ 16,668 | 🐛 404 | 🌐 C++ | 📅 2026-08-27 - The Arduino core for the ESP8266.
* [PlatformIO](https://github.com/platformio/platformio-core) ⭐ 9,430 | 🐛 310 | 🌐 Python | 📅 2026-08-27 - Cross Platform IDE and Debugger that supports both the ESP32 and ESP8266.
* [ESPTool](https://github.com/espressif/esptool) ⭐ 6,458 | 🐛 16 | 🌐 Python | 📅 2026-08-28 - Espressif's command line tool for bootloader comms in both ESP's.
...
* [ESPEasy](https://github.com/letscontrolit/ESPEasy) ⭐ 3,585 | 🐛 380 | 🌐 C++ | 📅 2026-08-27 - Easily turn ESP modules into multifunction sensor devices for home automation systems.
...
* [ESP32Marauder](https://github.com/justcallmekoko/ESP32Marauder) ⭐ 12,144 | 🐛 331 | 🌐 C++ | 📅 2026-08-28 - An integrated suite of offensive and defensive tools for WiFi and Bluetooth.
...
* [Squeezelite-esp32](https://github.com/sle118/squeezelite-esp32) ⭐ 2,174 | 🐛 90 | 🌐 C | 📅 2026-07-30 - Streaming audio receiver with multi-room sync, AirPlay, Bluetooth, hardware buttons, display and more.
...
* [SmartSpin2k](https://github.com/doudar/SmartSpin2k) ⭐ 278 | 🐛 26 | 🌐 C++ | 📅 2026-08-27 - Transform your spin bike into a smart trainer with automatic resistance knob control in fitness apps like Zwift.
...
* [IRremoteESP8266](https://github.com/markszabo/IRremoteESP8266) ⭐ 3,576 | 🐛 103 | 🌐 C++ | 📅 2026-08-23 - Emit and receive IR signals in the ESP8266.
...
* [LedFx](https://github.com/LedFx/LedFx) ⭐ 2,033 | 🐛 16 | 🌐 Python | 📅 2026-08-24 - A library for using audio input to create realtime light shows. LedFx can control multiple devices and works great with cheap ESP8266 nodes.
