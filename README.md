...
* [MicroPython](https://github.com/micropython/micropython/) ⭐ 22,043 | 🐛 1,523 | 🌐 C | 📅 2026-09-04 - An implemention of Python3 for the ESP8266 and 32.
* [RT-Thread](https://github.com/RT-Thread/rt-thread) ⭐ 12,190 | 🐛 493 | 🌐 C | 📅 2026-09-03 - Chinese open source firmware available for the ESP32.
* [NodeMCU](https://github.com/nodemcu/nodemcu-firmware) ⭐ 7,945 | 🐛 119 | 🌐 C | 📅 2026-06-07 - An eLua-based firmware for the ESP8266.
* [MongooseOS](https://github.com/cesanta/mongoose-os) ⭐ 2,664 | 🐛 97 | 🌐 C | 📅 2026-07-26 - An IoT specific firmware, with both C and JS. Available for the ESP32/8266.
...
* [Arduino Core/32](https://github.com/espressif/arduino-esp32) ⭐ 17,322 | 🐛 161 | 🌐 C++ | 📅 2026-09-04 - The other Arduino core for the ESP32.
* [Arduino Core/8266](https://github.com/esp8266/arduino) ⭐ 16,674 | 🐛 404 | 🌐 C++ | 📅 2026-08-27 - The Arduino core for the ESP8266.
* [PlatformIO](https://github.com/platformio/platformio-core) ⭐ 9,437 | 🐛 306 | 🌐 Python | 📅 2026-09-04 - Cross Platform IDE and Debugger that supports both the ESP32 and ESP8266.
* [ESPTool](https://github.com/espressif/esptool) ⭐ 6,468 | 🐛 14 | 🌐 Python | 📅 2026-09-02 - Espressif's command line tool for bootloader comms in both ESP's.
...
* [OpenMQTTGateway](https://github.com/1technophile/OpenMQTTGateway) ⭐ 4,084 | 🐛 47 | 🌐 C++ | 📅 2026-09-01 - An implementation of a multiprotocol MQTT gateway for both ESP's among other devices.
* [ESPEasy](https://github.com/letscontrolit/ESPEasy) ⭐ 3,595 | 🐛 386 | 🌐 C++ | 📅 2026-09-01 - Easily turn ESP modules into multifunction sensor devices for home automation systems.
...
* [CanAirIO](https://github.com/kike-canaries/canairio_firmware#canairio-firmware) ⭐ 128 | 🐛 30 | 🌐 C++ | 📅 2026-09-04 - Citizen science project that uses mobile and fixed stations to measure air quality with ESP32 and smartphones.
...
* [ESP8266 Deauther](https://github.com/spacehuhn/esp8266_deauther) ⭐ 14,955 | 🐛 99 | 🌐 C | 📅 2024-08-14 - A very cool pseudojammer (deauther) of Wifi networks that uses the ESP8266.
* [ESP32Marauder](https://github.com/justcallmekoko/ESP32Marauder) ⭐ 12,219 | 🐛 325 | 🌐 C++ | 📅 2026-09-04 - An integrated suite of offensive and defensive tools for WiFi and Bluetooth.
* [WiFiDuck](https://github.com/spacehuhn/WiFiDuck) ⭐ 3,286 | 🐛 22 | 🌐 C++ | 📅 2023-06-02 - A wireless-enabled keystroke injector, analogous, but even more awesome than the Rubber Ducky.
...
* [ESP32-Paxcounter](https://github.com/cyberman54/ESP32-Paxcounter#esp32-paxcounter) ⭐ 2,088 | 🐛 18 | 🌐 C++ | 📅 2026-08-12 - Wifi & Bluetooth driven, LoRaWAN enabled, battery powered mini Paxcounter built on cheap ESP32 LoRa IoT boards.
...
* [Squeezelite-esp32](https://github.com/sle118/squeezelite-esp32) ⭐ 2,186 | 🐛 91 | 🌐 C | 📅 2026-07-30 - Streaming audio receiver with multi-room sync, AirPlay, Bluetooth, hardware buttons, display and more.
...
* [SoftRF](https://github.com/lyusupov/SoftRF) ⭐ 1,011 | 🐛 0 | 🌐 C | 📅 2026-09-04 - A DIY aviation proximity awareness system that can be used in UAV projects.
...
* [SmartSpin2k](https://github.com/doudar/SmartSpin2k) ⭐ 279 | 🐛 27 | 🌐 C++ | 📅 2026-09-04 - Transform your spin bike into a smart trainer with automatic resistance knob control in fitness apps like Zwift.
* [WLED](https://kno.wled.ge/) - Control many types of RGB(W) LED strips with an ESP8266 or ESP32 over WiFi.

## Libraries

* [Wasm3](https://github.com/wasm3/wasm3) ⭐ 8,018 | 🐛 18 | 🌐 C | 📅 2026-09-04 - A lightning fast WebAssembly interpreter designed for embedded devices, compatible with both ESP's.
* [IRremoteESP8266](https://github.com/markszabo/IRremoteESP8266) ⭐ 3,588 | 🐛 103 | 🌐 C++ | 📅 2026-08-23 - Emit and receive IR signals in the ESP8266.
...
* [LedFx](https://github.com/LedFx/LedFx) ⭐ 2,039 | 🐛 17 | 🌐 Python | 📅 2026-08-31 - A library for using audio input to create realtime light shows. LedFx can control multiple devices and works great with cheap ESP8266 nodes.
* [ESP32-audioI2S](https://github.com/schreibfaul1/ESP32-audioI2S) ⭐ 1,687 | 🐛 15 | 🌐 C | 📅 2026-09-04 - Plays mp3, m4a and wav files from SD card or stream via I2S interface.
