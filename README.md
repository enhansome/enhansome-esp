...
* [MicroPython](https://github.com/micropython/micropython/) ⭐ 22,010 | 🐛 1,533 | 🌐 C | 📅 2026-08-25 - An implemention of Python3 for the ESP8266 and 32.
* [RT-Thread](https://github.com/RT-Thread/rt-thread) ⭐ 12,169 | 🐛 492 | 🌐 C | 📅 2026-08-26 - Chinese open source firmware available for the ESP32.
...
* [Arduino Core/32](https://github.com/espressif/arduino-esp32) ⭐ 17,283 | 🐛 154 | 🌐 C++ | 📅 2026-08-26 - The other Arduino core for the ESP32.
* [Arduino Core/8266](https://github.com/esp8266/arduino) ⭐ 16,668 | 🐛 406 | 🌐 C++ | 📅 2026-07-29 - The Arduino core for the ESP8266.
* [PlatformIO](https://github.com/platformio/platformio-core) ⭐ 9,424 | 🐛 310 | 🌐 Python | 📅 2026-08-25 - Cross Platform IDE and Debugger that supports both the ESP32 and ESP8266.
* [ESPTool](https://github.com/espressif/esptool) ⭐ 6,457 | 🐛 15 | 🌐 Python | 📅 2026-08-20 - Espressif's command line tool for bootloader comms in both ESP's.
...
* [OpenMQTTGateway](https://github.com/1technophile/OpenMQTTGateway) ⭐ 4,082 | 🐛 50 | 🌐 C++ | 📅 2026-08-25 - An implementation of a multiprotocol MQTT gateway for both ESP's among other devices.
* [ESPEasy](https://github.com/letscontrolit/ESPEasy) ⭐ 3,569 | 🐛 380 | 🌐 C++ | 📅 2026-08-25 - Easily turn ESP modules into multifunction sensor devices for home automation systems.
...
* [ESP8266 Deauther](https://github.com/spacehuhn/esp8266_deauther) ⭐ 14,942 | 🐛 99 | 🌐 C | 📅 2024-08-14 - A very cool pseudojammer (deauther) of Wifi networks that uses the ESP8266.
* [ESP32Marauder](https://github.com/justcallmekoko/ESP32Marauder) ⭐ 12,125 | 🐛 327 | 🌐 C++ | 📅 2026-08-26 - An integrated suite of offensive and defensive tools for WiFi and Bluetooth.
...
* [Squeezelite-esp32](https://github.com/sle118/squeezelite-esp32) ⭐ 2,172 | 🐛 89 | 🌐 C | 📅 2026-07-30 - Streaming audio receiver with multi-room sync, AirPlay, Bluetooth, hardware buttons, display and more.
...
* [PedalinoMini](https://github.com/alf45tar/PedalinoMini) ⭐ 614 | 🐛 47 | 🌐 Python | 📅 2026-05-04 - A wireless MIDI pedal controller for guitarists, built with the ESP32.
* [ESPuino](https://github.com/biologist79/ESPuino) ⭐ 417 | 🐛 5 | 🌐 C++ | 📅 2026-08-25 - RFID-controlled music player powered by ESP32.
...
* [SoftRF](https://github.com/lyusupov/SoftRF) ⭐ 1,005 | 🐛 0 | 🌐 C | 📅 2026-08-25 - A DIY aviation proximity awareness system that can be used in UAV projects.
...
* [Wasm3](https://github.com/wasm3/wasm3) ⭐ 8,001 | 🐛 40 | 🌐 C | 📅 2026-08-25 - A lightning fast WebAssembly interpreter designed for embedded devices, compatible with both ESP's.
* [IRremoteESP8266](https://github.com/markszabo/IRremoteESP8266) ⭐ 3,574 | 🐛 103 | 🌐 C++ | 📅 2026-08-23 - Emit and receive IR signals in the ESP8266.
...
* [HomeSpan](https://github.com/HomeSpan/HomeSpan) ⭐ 2,151 | 🐛 9 | 🌐 C++ | 📅 2026-08-24 - A robust and extremely easy-to-use Arduino library for creating your own ESP32-based HomeKit devices.
...
* [LedFx](https://github.com/LedFx/LedFx) ⭐ 2,031 | 🐛 15 | 🌐 Python | 📅 2026-08-24 - A library for using audio input to create realtime light shows. LedFx can control multiple devices and works great with cheap ESP8266 nodes.
* [ESP32-audioI2S](https://github.com/schreibfaul1/ESP32-audioI2S) ⭐ 1,680 | 🐛 29 | 🌐 C | 📅 2026-08-24 - Plays mp3, m4a and wav files from SD card or stream via I2S interface.
...
* [CanAirIO SensorLib](https://github.com/kike-canaries/canairio_sensorlib#canairio-air-quality-sensors-library) ⭐ 45 | 🐛 13 | 🌐 C++ | 📅 2026-08-13 - ESP32/8266 library with auto-configuration of multiple PM2.5, CO2 and environment sensors.
