...
* [MicroPython](https://github.com/micropython/micropython/) ⭐ 22,075 | 🐛 1,532 | 🌐 C | 📅 2026-09-19 - An implemention of Python3 for the ESP8266 and 32.
* [RT-Thread](https://github.com/RT-Thread/rt-thread) ⭐ 12,221 | 🐛 489 | 🌐 C | 📅 2026-09-17 - Chinese open source firmware available for the ESP32.
* [NodeMCU](https://github.com/nodemcu/nodemcu-firmware) ⭐ 7,946 | 🐛 119 | 🌐 C | 📅 2026-06-07 - An eLua-based firmware for the ESP8266.
* [MongooseOS](https://github.com/cesanta/mongoose-os) ⭐ 2,668 | 🐛 97 | 🌐 C | 📅 2026-07-26 - An IoT specific firmware, with both C and JS. Available for the ESP32/8266.
* [ESP3D](https://github.com/luc-github/ESP3D) ⭐ 1,994 | 🐛 5 | 🌐 C | 📅 2026-07-22 - An experimental firmware for 3D Printers, both the ESP32 and 8266.
* [Sming Framework](https://github.com/SmingHub/Sming) ⭐ 1,568 | 🐛 82 | 🌐 C++ | 📅 2026-09-06 - Superb C/C++ IoT Framework with support for ESP8266 and ESP32.
...
* [Arduino Core/32](https://github.com/espressif/arduino-esp32) ⭐ 17,405 | 🐛 151 | 🌐 C++ | 📅 2026-09-20 - The other Arduino core for the ESP32.
* [Arduino Core/8266](https://github.com/esp8266/arduino) ⭐ 16,686 | 🐛 405 | 🌐 C++ | 📅 2026-08-27 - The Arduino core for the ESP8266.
* [PlatformIO](https://github.com/platformio/platformio-core) ⭐ 9,471 | 🐛 272 | 🌐 Python | 📅 2026-09-19 - Cross Platform IDE and Debugger that supports both the ESP32 and ESP8266.
* [ESPTool](https://github.com/espressif/esptool) ⭐ 6,482 | 🐛 14 | 🌐 Python | 📅 2026-09-18 - Espressif's command line tool for bootloader comms in both ESP's.
* [Tuya-Convert](https://github.com/ct-Open-Source/tuya-convert) ⭐ 5,077 | 🐛 215 | 🌐 Python | 📅 2024-09-06 - A Wi-Fi firmware flasher ESP8266 that has been pre-loaded with Tuya firmware.
* [NodeMCU Flasher](https://github.com/nodemcu/nodemcu-flasher) ⭐ 2,219 | 🐛 47 | 🌐 Pascal | 📅 2017-08-08 - The official flashing tool for the NodeMCU OS.
...
* [LuaNode](https://github.com/Nicholas3388/LuaNode) ⭐ 1,334 | 🐛 36 | 🌐 C | 📅 2024-05-30 - A lua-only SDK for 32/8266.
...
* [OpenMQTTGateway](https://github.com/1technophile/OpenMQTTGateway) ⭐ 4,095 | 🐛 47 | 🌐 C++ | 📅 2026-09-20 - An implementation of a multiprotocol MQTT gateway for both ESP's among other devices.
* [ESPEasy](https://github.com/letscontrolit/ESPEasy) ⭐ 3,605 | 🐛 385 | 🌐 C++ | 📅 2026-09-16 - Easily turn ESP modules into multifunction sensor devices for home automation systems.
...
* [CanAirIO](https://github.com/kike-canaries/canairio_firmware#canairio-firmware) ⭐ 128 | 🐛 30 | 🌐 C++ | 📅 2026-09-12 - Citizen science project that uses mobile and fixed stations to measure air quality with ESP32 and smartphones.
...
* [ESP8266 Deauther](https://github.com/spacehuhn/esp8266_deauther) ⭐ 14,988 | 🐛 99 | 🌐 C | 📅 2024-08-14 - A very cool pseudojammer (deauther) of Wifi networks that uses the ESP8266.
* [ESP32Marauder](https://github.com/justcallmekoko/ESP32Marauder) ⭐ 12,404 | 🐛 333 | 🌐 C++ | 📅 2026-09-17 - An integrated suite of offensive and defensive tools for WiFi and Bluetooth.
* [WiFiDuck](https://github.com/spacehuhn/WiFiDuck) ⭐ 3,306 | 🐛 22 | 🌐 C++ | 📅 2023-06-02 - A wireless-enabled keystroke injector, analogous, but even more awesome than the Rubber Ducky.
* [ESP8266 Beacon Spam](https://github.com/spacehuhn/esp8266_beaconSpam) ⭐ 1,376 | 🐛 25 | 🌐 C++ | 📅 2024-08-08 - Want to confuse people? This device creates hundreds of fake WiFi networks.
* [DeauthDetector](https://github.com/spacehuhn/DeauthDetector) ⭐ 979 | 🐛 19 | 🌐 C++ | 📅 2023-08-28 - A small device that shines a light if it detects a WiFi deauth attack. Made by the same guy as the last six projects.
...
* [PacketMonitor](https://github.com/spacehuhn/PacketMonitor32) ⭐ 405 | 🐛 7 | 🌐 C++ | 📅 2020-11-20 - A beautiful OLED monitor for packet activity in a WiFi channel. Two versions for each ESP.
...
* [ESP32-Paxcounter](https://github.com/cyberman54/ESP32-Paxcounter#esp32-paxcounter) ⭐ 2,094 | 🐛 18 | 🌐 C++ | 📅 2026-08-12 - Wifi & Bluetooth driven, LoRaWAN enabled, battery powered mini Paxcounter built on cheap ESP32 LoRa IoT boards.
...
* [Squeezelite-esp32](https://github.com/sle118/squeezelite-esp32) ⭐ 2,198 | 🐛 97 | 🌐 C | 📅 2026-07-30 - Streaming audio receiver with multi-room sync, AirPlay, Bluetooth, hardware buttons, display and more.
* [ESP32-Radio](https://github.com/Edzelf/ESP32-Radio) ⭐ 1,070 | 🐛 343 | 🌐 C++ | 📅 2024-10-21 - Internet radio based on ESP32, VS1053 and a TFT screen.
* [PedalinoMini](https://github.com/alf45tar/PedalinoMini) ⭐ 618 | 🐛 48 | 🌐 Python | 📅 2026-05-04 - A wireless MIDI pedal controller for guitarists, built with the ESP32.
* [ESPuino](https://github.com/biologist79/ESPuino) ⭐ 424 | 🐛 1 | 🌐 C++ | 📅 2026-09-19 - RFID-controlled music player powered by ESP32.
...
* [ThingPulse esp8266-spotify-remote](https://github.com/ThingPulse/esp8266-spotify-remote) ⭐ 275 | 🐛 1 | 🌐 C | 📅 2023-09-30 - Control your Spotify player from a ESP8266 with color touch display.
...
* [DroneBridge](https://github.com/DroneBridge/ESP32) ⭐ 1,100 | 🐛 7 | 🌐 C | 📅 2026-09-12 - An implementation of DroneBridge, a signal link for drones and UAV's on the ESP32.
* [SoftRF](https://github.com/lyusupov/SoftRF) ⭐ 1,022 | 🐛 0 | 🌐 C | 📅 2026-09-07 - A DIY aviation proximity awareness system that can be used in UAV projects.
* [Retro ESP32](https://github.com/retro-esp32/RetroESP32) ⭐ 732 | 🐛 21 | 🌐 C | 📅 2024-07-31 - An extremely cool launcher for the Odroid Go (with the ESP32), which allows emulating several retro consoles.
...
* [E-TKT](https://github.com/andreisperid/E-TKT) ⭐ 476 | 🐛 20 | 🌐 C++ | 📅 2023-05-04 - An ESP32 powered DIY label maker that mixes both old fashioned and contemporary technology.
...
* [SmartSpin2k](https://github.com/doudar/SmartSpin2k) ⭐ 283 | 🐛 28 | 🌐 C++ | 📅 2026-09-19 - Transform your spin bike into a smart trainer with automatic resistance knob control in fitness apps like Zwift.
* [WLED](https://kno.wled.ge/) - Control many types of RGB(W) LED strips with an ESP8266 or ESP32 over WiFi.

## Libraries

* [Wasm3](https://github.com/wasm3/wasm3) ⭐ 8,029 | 🐛 19 | 🌐 C | 📅 2026-09-19 - A lightning fast WebAssembly interpreter designed for embedded devices, compatible with both ESP's.
* [IRremoteESP8266](https://github.com/markszabo/IRremoteESP8266) ⭐ 3,601 | 🐛 107 | 🌐 C++ | 📅 2026-08-23 - Emit and receive IR signals in the ESP8266.
* [ESPAudio](https://github.com/earlephilhower/ESP8266Audio) ⭐ 2,397 | 🐛 0 | 🌐 C | 📅 2026-08-02 - Library for playing a diverse range of audio formats in the ESP8266/ESP32.
* [TinyGSM](https://github.com/vshymanskyy/TinyGSM) ⭐ 2,215 | 🐛 354 | 🌐 C++ | 📅 2026-07-21 - A quick and simple Arduino library for interaction with GSM modules which can also control the 8266 through AT commands.
* [HomeSpan](https://github.com/HomeSpan/HomeSpan) ⭐ 2,166 | 🐛 9 | 🌐 C++ | 📅 2026-09-15 - A robust and extremely easy-to-use Arduino library for creating your own ESP32-based HomeKit devices.
* [mJS](https://github.com/cesanta/mjs) ⭐ 2,057 | 🐛 196 | 🌐 C | 📅 2026-03-16 - A lightweight and restricted JS engine that is used by MongooseOS, compatible on the 32 and 8266.
* [LedFx](https://github.com/LedFx/LedFx) ⭐ 2,051 | 🐛 17 | 🌐 Python | 📅 2026-09-14 - A library for using audio input to create realtime light shows. LedFx can control multiple devices and works great with cheap ESP8266 nodes.
* [ESP32-audioI2S](https://github.com/schreibfaul1/ESP32-audioI2S) ⭐ 1,696 | 🐛 11 | 🌐 C | 📅 2026-09-18 - Plays mp3, m4a and wav files from SD card or stream via I2S interface.
* [ESP-Dash](https://github.com/ayushsharma82/ESP-DASH) ⭐ 1,408 | 🐛 1 | 🌐 C++ | 📅 2025-11-22 - Beautiful and fast framework for creating remote dashboards in the 8266/32. No internet required.
* [Homie8266](https://github.com/marvinroger/homie-esp8266) ⭐ 1,374 | 🐛 89 | 🌐 HTML | 📅 2026-03-06 - Framework implementation of the Homie protocol for the 8266.
* [GUIslice](https://github.com/ImpulseAdventure/GUIslice) ⭐ 1,365 | 🐛 48 | 🌐 C | 📅 2026-07-14 - A drag and drop GUI framework for several devices and screen controllers. Compatible with 8266 and 32.
* [ESP\_mqtt](https://github.com/tuanpmt/esp_mqtt) ⭐ 1,172 | 🐛 41 | 🌐 C | 📅 2020-12-22 - MQTT helper library for the ESP8266.
* [ESP-HomeKit](https://github.com/maximkulkin/esp-homekit) ⭐ 1,166 | 🐛 33 | 🌐 C | 📅 2023-12-18 - Homekit implementation for 8266 on RTOS.
* [ESPUI](https://github.com/s00500/ESPUI) ⭐ 1,125 | 🐛 53 | 🌐 C++ | 📅 2026-04-30 - A simply library for making interactive web interfaces for both ESP's.
...
* [painlessMesh](https://github.com/gmag11/painlessMesh) ⭐ 562 | 🐛 0 | 🌐 C++ | 📅 2019-08-29 - A library that takes care of the particulars of creating a simple mesh network using ESP8266 and ESP32 hardware.
...
* [WifiEspNow](https://github.com/yoursunny/WifiEspNow) ⭐ 295 | 🐛 7 | 🌐 C++ | 📅 2026-03-18 - Arduino library for [ESP-NOW](https://docs.espressif.com/projects/esp-idf/en/latest/esp32/api-reference/network/esp_now.html), a connectionless WiFi communication protocol defined by [Espressif](https://github.com/espressif).
...
* [CanAirIO SensorLib](https://github.com/kike-canaries/canairio_sensorlib#canairio-air-quality-sensors-library) ⭐ 45 | 🐛 6 | 🌐 C++ | 📅 2026-09-01 - ESP32/8266 library with auto-configuration of multiple PM2.5, CO2 and environment sensors.
