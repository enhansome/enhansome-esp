...
* [MicroPython](https://github.com/micropython/micropython/) ⭐ 22,076 | 🐛 1,530 | 🌐 C | 📅 2026-09-21 - An implemention of Python3 for the ESP8266 and 32.
* [RT-Thread](https://github.com/RT-Thread/rt-thread) ⭐ 12,224 | 🐛 475 | 🌐 C | 📅 2026-09-21 - Chinese open source firmware available for the ESP32.
...
* [ESP3D](https://github.com/luc-github/ESP3D) ⭐ 1,995 | 🐛 5 | 🌐 C | 📅 2026-07-22 - An experimental firmware for 3D Printers, both the ESP32 and 8266.
...
* [Arduino Core/32](https://github.com/espressif/arduino-esp32) ⭐ 17,410 | 🐛 156 | 🌐 C++ | 📅 2026-09-21 - The other Arduino core for the ESP32.
* [Arduino Core/8266](https://github.com/esp8266/arduino) ⭐ 16,686 | 🐛 405 | 🌐 C++ | 📅 2026-08-27 - The Arduino core for the ESP8266.
* [PlatformIO](https://github.com/platformio/platformio-core) ⭐ 9,473 | 🐛 272 | 🌐 Python | 📅 2026-09-19 - Cross Platform IDE and Debugger that supports both the ESP32 and ESP8266.
* [ESPTool](https://github.com/espressif/esptool) ⭐ 6,483 | 🐛 14 | 🌐 Python | 📅 2026-09-18 - Espressif's command line tool for bootloader comms in both ESP's.
...
* [OpenMQTTGateway](https://github.com/1technophile/OpenMQTTGateway) ⭐ 4,095 | 🐛 47 | 🌐 C++ | 📅 2026-09-21 - An implementation of a multiprotocol MQTT gateway for both ESP's among other devices.
* [ESPEasy](https://github.com/letscontrolit/ESPEasy) ⭐ 3,605 | 🐛 386 | 🌐 C++ | 📅 2026-09-16 - Easily turn ESP modules into multifunction sensor devices for home automation systems.
...
* [ESP8266 Deauther](https://github.com/spacehuhn/esp8266_deauther) ⭐ 14,993 | 🐛 99 | 🌐 C | 📅 2024-08-14 - A very cool pseudojammer (deauther) of Wifi networks that uses the ESP8266.
* [ESP32Marauder](https://github.com/justcallmekoko/ESP32Marauder) ⭐ 12,415 | 🐛 333 | 🌐 C++ | 📅 2026-09-17 - An integrated suite of offensive and defensive tools for WiFi and Bluetooth.
* [WiFiDuck](https://github.com/spacehuhn/WiFiDuck) ⭐ 3,307 | 🐛 22 | 🌐 C++ | 📅 2023-06-02 - A wireless-enabled keystroke injector, analogous, but even more awesome than the Rubber Ducky.
...
* [PedalinoMini](https://github.com/alf45tar/PedalinoMini) ⭐ 619 | 🐛 48 | 🌐 Python | 📅 2026-05-04 - A wireless MIDI pedal controller for guitarists, built with the ESP32.
* [ESPuino](https://github.com/biologist79/ESPuino) ⭐ 425 | 🐛 1 | 🌐 C++ | 📅 2026-09-19 - RFID-controlled music player powered by ESP32.
...
* [DroneBridge](https://github.com/DroneBridge/ESP32) ⭐ 1,103 | 🐛 7 | 🌐 C | 📅 2026-09-12 - An implementation of DroneBridge, a signal link for drones and UAV's on the ESP32.
...
* [E-TKT](https://github.com/andreisperid/E-TKT) ⭐ 477 | 🐛 20 | 🌐 C++ | 📅 2023-05-04 - An ESP32 powered DIY label maker that mixes both old fashioned and contemporary technology.
...
* [TinyGSM](https://github.com/vshymanskyy/TinyGSM) ⭐ 2,216 | 🐛 354 | 🌐 C++ | 📅 2026-07-21 - A quick and simple Arduino library for interaction with GSM modules which can also control the 8266 through AT commands.
...
* [LedFx](https://github.com/LedFx/LedFx) ⭐ 2,052 | 🐛 19 | 🌐 Python | 📅 2026-09-14 - A library for using audio input to create realtime light shows. LedFx can control multiple devices and works great with cheap ESP8266 nodes.
* [ESP32-audioI2S](https://github.com/schreibfaul1/ESP32-audioI2S) ⭐ 1,696 | 🐛 12 | 🌐 C | 📅 2026-09-18 - Plays mp3, m4a and wav files from SD card or stream via I2S interface.
