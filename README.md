...
* [MicroPython](https://github.com/micropython/micropython/) ⭐ 21,990 | 🐛 1,528 | 🌐 C | 📅 2026-08-14 - An implemention of Python3 for the ESP8266 and 32.
* [RT-Thread](https://github.com/RT-Thread/rt-thread) ⭐ 12,147 | 🐛 485 | 🌐 C | 📅 2026-08-13 - Chinese open source firmware available for the ESP32.
* [NodeMCU](https://github.com/nodemcu/nodemcu-firmware) ⭐ 7,940 | 🐛 119 | 🌐 C | 📅 2026-06-07 - An eLua-based firmware for the ESP8266.
* [MongooseOS](https://github.com/cesanta/mongoose-os) ⭐ 2,661 | 🐛 97 | 🌐 C | 📅 2026-07-26 - An IoT specific firmware, with both C and JS. Available for the ESP32/8266.
* [ESP3D](https://github.com/luc-github/ESP3D) ⭐ 1,989 | 🐛 6 | 🌐 C | 📅 2026-07-22 - An experimental firmware for 3D Printers, both the ESP32 and 8266.
...
* [Arduino Core/32](https://github.com/espressif/arduino-esp32) ⭐ 17,229 | 🐛 165 | 🌐 C++ | 📅 2026-08-13 - The other Arduino core for the ESP32.
* [Arduino Core/8266](https://github.com/esp8266/arduino) ⭐ 16,664 | 🐛 405 | 🌐 C++ | 📅 2026-07-29 - The Arduino core for the ESP8266.
* [PlatformIO](https://github.com/platformio/platformio-core) ⭐ 9,400 | 🐛 316 | 🌐 Python | 📅 2026-08-11 - Cross Platform IDE and Debugger that supports both the ESP32 and ESP8266.
* [ESPTool](https://github.com/espressif/esptool) ⭐ 6,439 | 🐛 13 | 🌐 Python | 📅 2026-08-10 - Espressif's command line tool for bootloader comms in both ESP's.
...
* [Tasmotizer](https://github.com/tasmota/tasmotizer) ⭐ 1,538 | 🐛 38 | 🌐 Python | 📅 2024-01-30 - A graphical flashing tool for Tasmota firmware. Can manage Wi-Fi & MQTT settings, modules & templates.
* [LuaNode](https://github.com/Nicholas3388/LuaNode) ⭐ 1,329 | 🐛 36 | 🌐 C | 📅 2024-05-30 - A lua-only SDK for 32/8266.
* [Arduino FS Plugin](https://github.com/esp8266/arduino-esp8266fs-plugin) ⭐ 738 | 🐛 57 | 🌐 Java | 📅 2022-11-30 - An Arduino plugin for filesystem uploads in the 8266.
...
* [OpenMQTTGateway](https://github.com/1technophile/OpenMQTTGateway) ⭐ 4,075 | 🐛 51 | 🌐 C++ | 📅 2026-08-14 - An implementation of a multiprotocol MQTT gateway for both ESP's among other devices.
* [ESPEasy](https://github.com/letscontrolit/ESPEasy) ⭐ 3,557 | 🐛 385 | 🌐 C++ | 📅 2026-08-08 - Easily turn ESP modules into multifunction sensor devices for home automation systems.
...
* [HomePoint](https://github.com/sieren/Homepoint) ⭐ 659 | 🐛 29 | 🌐 C | 📅 2022-08-04 - Control MQTT/HomeKit smart home devices from an ESP32-powered screen.
* [SuperGreenOS](https://github.com/supergreenlab/SuperGreenOS) ⭐ 219 | 🐛 1 | 🌐 C | 📅 2024-06-05 - A full-featured home farming automation software for the ESP32.
...
* [CanAirIO](https://github.com/kike-canaries/canairio_firmware#canairio-firmware) ⭐ 129 | 🐛 29 | 🌐 C++ | 📅 2026-08-14 - Citizen science project that uses mobile and fixed stations to measure air quality with ESP32 and smartphones.
...
* [ESP8266 Deauther](https://github.com/spacehuhn/esp8266_deauther) ⭐ 14,915 | 🐛 99 | 🌐 C | 📅 2024-08-14 - A very cool pseudojammer (deauther) of Wifi networks that uses the ESP8266.
* [ESP32Marauder](https://github.com/justcallmekoko/ESP32Marauder) ⭐ 11,962 | 🐛 321 | 🌐 C++ | 📅 2026-08-14 - An integrated suite of offensive and defensive tools for WiFi and Bluetooth.
* [WiFiDuck](https://github.com/spacehuhn/WiFiDuck) ⭐ 3,120 | 🐛 22 | 🌐 C++ | 📅 2023-06-02 - A wireless-enabled keystroke injector, analogous, but even more awesome than the Rubber Ducky.
* [ESP8266 Beacon Spam](https://github.com/spacehuhn/esp8266_beaconSpam) ⭐ 1,357 | 🐛 25 | 🌐 C++ | 📅 2024-08-08 - Want to confuse people? This device creates hundreds of fake WiFi networks.
* [DeauthDetector](https://github.com/spacehuhn/DeauthDetector) ⭐ 969 | 🐛 19 | 🌐 C++ | 📅 2023-08-28 - A small device that shines a light if it detects a WiFi deauth attack. Made by the same guy as the last six projects.
* [ArduinoPcap](https://github.com/spacehuhn/ArduinoPcap) ⭐ 462 | 🐛 15 | 🌐 C++ | 📅 2024-03-03 - A library which allows generation of .pcap files with network traffic, for both ESP's.
* [PacketMonitor](https://github.com/spacehuhn/PacketMonitor32) ⭐ 401 | 🐛 7 | 🌐 C++ | 📅 2020-11-20 - A beautiful OLED monitor for packet activity in a WiFi channel. Two versions for each ESP.
* [ESP32-BLECollector](https://github.com/tobozo/ESP32-BLECollector) ⭐ 361 | 🐛 1 | 🌐 C | 📅 2024-09-04 - A wardriving device which displays BLE devices and collects data from them, all in a nice screen interface.
...
* [ESP32-Paxcounter](https://github.com/cyberman54/ESP32-Paxcounter#esp32-paxcounter) ⭐ 2,080 | 🐛 18 | 🌐 C++ | 📅 2026-08-12 - Wifi & Bluetooth driven, LoRaWAN enabled, battery powered mini Paxcounter built on cheap ESP32 LoRa IoT boards.
* [Disaster Radio](https://disaster.radio/) - A disaster-resilient communications network powered by the sun.

### Music and Audio

* [Squeezelite-esp32](https://github.com/sle118/squeezelite-esp32) ⭐ 2,152 | 🐛 88 | 🌐 C | 📅 2026-07-30 - Streaming audio receiver with multi-room sync, AirPlay, Bluetooth, hardware buttons, display and more.
* [ESP32-Radio](https://github.com/Edzelf/ESP32-Radio) ⭐ 1,064 | 🐛 343 | 🌐 C++ | 📅 2024-10-21 - Internet radio based on ESP32, VS1053 and a TFT screen.
* [PedalinoMini](https://github.com/alf45tar/PedalinoMini) ⭐ 612 | 🐛 47 | 🌐 Python | 📅 2026-05-04 - A wireless MIDI pedal controller for guitarists, built with the ESP32.
* [ESPuino](https://github.com/biologist79/ESPuino) ⭐ 417 | 🐛 8 | 🌐 C++ | 📅 2026-08-13 - RFID-controlled music player powered by ESP32.
* [Alles](https://github.com/bwhitman/alles) ⭐ 321 | 🐛 2 | 🌐 C | 📅 2024-11-04 - A many speaker distributed music synthesizer using UDP multicast over WiFi, modeled after the alles machine/AMY.
...
* [DroneBridge](https://github.com/DroneBridge/ESP32) ⭐ 1,000 | 🐛 8 | 🌐 C | 📅 2026-08-13 - An implementation of DroneBridge, a signal link for drones and UAV's on the ESP32.
* [SoftRF](https://github.com/lyusupov/SoftRF) ⭐ 999 | 🐛 0 | 🌐 C | 📅 2026-08-13 - A DIY aviation proximity awareness system that can be used in UAV projects.
* [Retro ESP32](https://github.com/retro-esp32/RetroESP32) ⭐ 722 | 🐛 21 | 🌐 C | 📅 2024-07-31 - An extremely cool launcher for the Odroid Go (with the ESP32), which allows emulating several retro consoles.
* [FreeTouchDeck](https://github.com/DustinWatts/FreeTouchDeck) ⭐ 709 | 🐛 0 | 🌐 C | 📅 2024-05-22 - Open source touch macropad and stream control deck with built-in web configurator.
* [E-TKT](https://github.com/andreisperid/E-TKT) ⭐ 472 | 🐛 20 | 🌐 C++ | 📅 2023-05-04 - An ESP32 powered DIY label maker that mixes both old fashioned and contemporary technology.
...
* [SmartSpin2k](https://github.com/doudar/SmartSpin2k) ⭐ 277 | 🐛 27 | 🌐 C++ | 📅 2026-08-14 - Transform your spin bike into a smart trainer with automatic resistance knob control in fitness apps like Zwift.
* [WLED](https://kno.wled.ge/) - Control many types of RGB(W) LED strips with an ESP8266 or ESP32 over WiFi.

## Libraries

* [Wasm3](https://github.com/wasm3/wasm3) ⭐ 7,972 | 🐛 64 | 🌐 C | 📅 2026-08-12 - A lightning fast WebAssembly interpreter designed for embedded devices, compatible with both ESP's.
* [IRremoteESP8266](https://github.com/markszabo/IRremoteESP8266) ⭐ 3,568 | 🐛 102 | 🌐 C++ | 📅 2026-08-02 - Emit and receive IR signals in the ESP8266.
* [ESPAudio](https://github.com/earlephilhower/ESP8266Audio) ⭐ 2,386 | 🐛 0 | 🌐 C | 📅 2026-08-02 - Library for playing a diverse range of audio formats in the ESP8266/ESP32.
* [TinyGSM](https://github.com/vshymanskyy/TinyGSM) ⭐ 2,211 | 🐛 354 | 🌐 C++ | 📅 2026-07-21 - A quick and simple Arduino library for interaction with GSM modules which can also control the 8266 through AT commands.
* [HomeSpan](https://github.com/HomeSpan/HomeSpan) ⭐ 2,146 | 🐛 8 | 🌐 C++ | 📅 2026-08-13 - A robust and extremely easy-to-use Arduino library for creating your own ESP32-based HomeKit devices.
...
* [LedFx](https://github.com/LedFx/LedFx) ⭐ 2,020 | 🐛 16 | 🌐 Python | 📅 2026-08-10 - A library for using audio input to create realtime light shows. LedFx can control multiple devices and works great with cheap ESP8266 nodes.
* [ESP32-audioI2S](https://github.com/schreibfaul1/ESP32-audioI2S) ⭐ 1,664 | 🐛 32 | 🌐 C | 📅 2026-08-13 - Plays mp3, m4a and wav files from SD card or stream via I2S interface.
* [ESP-Dash](https://github.com/ayushsharma82/ESP-DASH) ⭐ 1,396 | 🐛 0 | 🌐 C++ | 📅 2025-11-22 - Beautiful and fast framework for creating remote dashboards in the 8266/32. No internet required.
...
* [GUIslice](https://github.com/ImpulseAdventure/GUIslice) ⭐ 1,360 | 🐛 48 | 🌐 C | 📅 2026-07-14 - A drag and drop GUI framework for several devices and screen controllers. Compatible with 8266 and 32.
...
* [ESPUI](https://github.com/s00500/ESPUI) ⭐ 1,122 | 🐛 53 | 🌐 C++ | 📅 2026-04-30 - A simply library for making interactive web interfaces for both ESP's.
...
* [CanAirIO SensorLib](https://github.com/kike-canaries/canairio_sensorlib#canairio-air-quality-sensors-library) ⭐ 45 | 🐛 11 | 🌐 C++ | 📅 2026-08-13 - ESP32/8266 library with auto-configuration of multiple PM2.5, CO2 and environment sensors.
