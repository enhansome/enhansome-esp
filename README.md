...
* [MicroPython](https://github.com/micropython/micropython/) ⭐ 22,046 | 🐛 1,527 | 🌐 C | 📅 2026-09-04 - An implemention of Python3 for the ESP8266 and 32.
* [RT-Thread](https://github.com/RT-Thread/rt-thread) ⭐ 12,192 | 🐛 494 | 🌐 C | 📅 2026-09-03 - Chinese open source firmware available for the ESP32.
...
* [Arduino Core/32](https://github.com/espressif/arduino-esp32) ⭐ 17,329 | 🐛 163 | 🌐 C++ | 📅 2026-09-06 - The other Arduino core for the ESP32.
* [Arduino Core/8266](https://github.com/esp8266/arduino) ⭐ 16,677 | 🐛 404 | 🌐 C++ | 📅 2026-08-27 - The Arduino core for the ESP8266.
* [PlatformIO](https://github.com/platformio/platformio-core) ⭐ 9,438 | 🐛 278 | 🌐 Python | 📅 2026-09-05 - Cross Platform IDE and Debugger that supports both the ESP32 and ESP8266.
...
* [OpenMQTTGateway](https://github.com/1technophile/OpenMQTTGateway) ⭐ 4,085 | 🐛 47 | 🌐 C++ | 📅 2026-09-01 - An implementation of a multiprotocol MQTT gateway for both ESP's among other devices.
* [ESPEasy](https://github.com/letscontrolit/ESPEasy) ⭐ 3,597 | 🐛 386 | 🌐 C++ | 📅 2026-09-01 - Easily turn ESP modules into multifunction sensor devices for home automation systems.
...
* [ESP32Marauder](https://github.com/justcallmekoko/ESP32Marauder) ⭐ 12,225 | 🐛 325 | 🌐 C++ | 📅 2026-09-05 - An integrated suite of offensive and defensive tools for WiFi and Bluetooth.
* [WiFiDuck](https://github.com/spacehuhn/WiFiDuck) ⭐ 3,287 | 🐛 22 | 🌐 C++ | 📅 2023-06-02 - A wireless-enabled keystroke injector, analogous, but even more awesome than the Rubber Ducky.
...
* [ESPuino](https://github.com/biologist79/ESPuino) ⭐ 419 | 🐛 2 | 🌐 C++ | 📅 2026-09-05 - RFID-controlled music player powered by ESP32.
...
* [DroneBridge](https://github.com/DroneBridge/ESP32) ⭐ 1,082 | 🐛 7 | 🌐 C | 📅 2026-08-26 - An implementation of DroneBridge, a signal link for drones and UAV's on the ESP32.
* [SoftRF](https://github.com/lyusupov/SoftRF) ⭐ 1,013 | 🐛 0 | 🌐 C | 📅 2026-09-04 - A DIY aviation proximity awareness system that can be used in UAV projects.
...
* [SmartSpin2k](https://github.com/doudar/SmartSpin2k) ⭐ 279 | 🐛 28 | 🌐 C++ | 📅 2026-09-05 - Transform your spin bike into a smart trainer with automatic resistance knob control in fitness apps like Zwift.
* [WLED](https://kno.wled.ge/) - Control many types of RGB(W) LED strips with an ESP8266 or ESP32 over WiFi.

## Libraries

* [Wasm3](https://github.com/wasm3/wasm3) ⭐ 8,022 | 🐛 18 | 🌐 C | 📅 2026-09-05 - A lightning fast WebAssembly interpreter designed for embedded devices, compatible with both ESP's.
* [IRremoteESP8266](https://github.com/markszabo/IRremoteESP8266) ⭐ 3,590 | 🐛 103 | 🌐 C++ | 📅 2026-08-23 - Emit and receive IR signals in the ESP8266.
...
* [HomeSpan](https://github.com/HomeSpan/HomeSpan) ⭐ 2,156 | 🐛 9 | 🌐 C++ | 📅 2026-09-05 - A robust and extremely easy-to-use Arduino library for creating your own ESP32-based HomeKit devices.
...
* [ESP32-audioI2S](https://github.com/schreibfaul1/ESP32-audioI2S) ⭐ 1,688 | 🐛 14 | 🌐 C | 📅 2026-09-04 - Plays mp3, m4a and wav files from SD card or stream via I2S interface.
...
* [GUIslice](https://github.com/ImpulseAdventure/GUIslice) ⭐ 1,363 | 🐛 48 | 🌐 C | 📅 2026-07-14 - A drag and drop GUI framework for several devices and screen controllers. Compatible with 8266 and 32.
