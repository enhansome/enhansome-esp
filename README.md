...
* [MicroPython](https://github.com/micropython/micropython/) ⭐ 21,992 | 🐛 1,536 | 🌐 C | 📅 2026-08-16 - An implemention of Python3 for the ESP8266 and 32.
* [RT-Thread](https://github.com/RT-Thread/rt-thread) ⭐ 12,153 | 🐛 483 | 🌐 C | 📅 2026-08-14 - Chinese open source firmware available for the ESP32.
...
* [Arduino Core/32](https://github.com/espressif/arduino-esp32) ⭐ 17,230 | 🐛 169 | 🌐 C++ | 📅 2026-08-13 - The other Arduino core for the ESP32.
* [Arduino Core/8266](https://github.com/esp8266/arduino) ⭐ 16,666 | 🐛 406 | 🌐 C++ | 📅 2026-07-29 - The Arduino core for the ESP8266.
* [PlatformIO](https://github.com/platformio/platformio-core) ⭐ 9,405 | 🐛 317 | 🌐 Python | 📅 2026-08-11 - Cross Platform IDE and Debugger that supports both the ESP32 and ESP8266.
* [ESPTool](https://github.com/espressif/esptool) ⭐ 6,442 | 🐛 13 | 🌐 Python | 📅 2026-08-10 - Espressif's command line tool for bootloader comms in both ESP's.
...
* [OpenMQTTGateway](https://github.com/1technophile/OpenMQTTGateway) ⭐ 4,076 | 🐛 52 | 🌐 C++ | 📅 2026-08-16 - An implementation of a multiprotocol MQTT gateway for both ESP's among other devices.
...
* [ESP8266 Deauther](https://github.com/spacehuhn/esp8266_deauther) ⭐ 14,918 | 🐛 99 | 🌐 C | 📅 2024-08-14 - A very cool pseudojammer (deauther) of Wifi networks that uses the ESP8266.
* [ESP32Marauder](https://github.com/justcallmekoko/ESP32Marauder) ⭐ 11,982 | 🐛 321 | 🌐 C++ | 📅 2026-08-16 - An integrated suite of offensive and defensive tools for WiFi and Bluetooth.
* [WiFiDuck](https://github.com/spacehuhn/WiFiDuck) ⭐ 3,123 | 🐛 22 | 🌐 C++ | 📅 2023-06-02 - A wireless-enabled keystroke injector, analogous, but even more awesome than the Rubber Ducky.
...
* [Squeezelite-esp32](https://github.com/sle118/squeezelite-esp32) ⭐ 2,157 | 🐛 88 | 🌐 C | 📅 2026-07-30 - Streaming audio receiver with multi-room sync, AirPlay, Bluetooth, hardware buttons, display and more.
...
* [DroneBridge](https://github.com/DroneBridge/ESP32) ⭐ 1,001 | 🐛 9 | 🌐 C | 📅 2026-08-13 - An implementation of DroneBridge, a signal link for drones and UAV's on the ESP32.
* [SoftRF](https://github.com/lyusupov/SoftRF) ⭐ 1,000 | 🐛 0 | 🌐 C | 📅 2026-08-15 - A DIY aviation proximity awareness system that can be used in UAV projects.
...
* [IRremoteESP8266](https://github.com/markszabo/IRremoteESP8266) ⭐ 3,570 | 🐛 101 | 🌐 C++ | 📅 2026-08-14 - Emit and receive IR signals in the ESP8266.
...
* [ESP32-audioI2S](https://github.com/schreibfaul1/ESP32-audioI2S) ⭐ 1,667 | 🐛 31 | 🌐 C | 📅 2026-08-13 - Plays mp3, m4a and wav files from SD card or stream via I2S interface.
