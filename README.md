...
* [MicroPython](https://github.com/micropython/micropython/) ⭐ 22,004 | 🐛 1,537 | 🌐 C | 📅 2026-08-18 - An implemention of Python3 for the ESP8266 and 32.
* [RT-Thread](https://github.com/RT-Thread/rt-thread) ⭐ 12,163 | 🐛 480 | 🌐 C | 📅 2026-08-21 - Chinese open source firmware available for the ESP32.
...
* [Arduino Core/32](https://github.com/espressif/arduino-esp32) ⭐ 17,266 | 🐛 156 | 🌐 C++ | 📅 2026-08-22 - The other Arduino core for the ESP32.
* [Arduino Core/8266](https://github.com/esp8266/arduino) ⭐ 16,666 | 🐛 406 | 🌐 C++ | 📅 2026-07-29 - The Arduino core for the ESP8266.
* [PlatformIO](https://github.com/platformio/platformio-core) ⭐ 9,415 | 🐛 316 | 🌐 Python | 📅 2026-08-11 - Cross Platform IDE and Debugger that supports both the ESP32 and ESP8266.
* [ESPTool](https://github.com/espressif/esptool) ⭐ 6,450 | 🐛 16 | 🌐 Python | 📅 2026-08-20 - Espressif's command line tool for bootloader comms in both ESP's.
...
* [ESPEasy](https://github.com/letscontrolit/ESPEasy) ⭐ 3,567 | 🐛 378 | 🌐 C++ | 📅 2026-08-21 - Easily turn ESP modules into multifunction sensor devices for home automation systems.
...
* [ESP8266 Deauther](https://github.com/spacehuhn/esp8266_deauther) ⭐ 14,930 | 🐛 99 | 🌐 C | 📅 2024-08-14 - A very cool pseudojammer (deauther) of Wifi networks that uses the ESP8266.
* [ESP32Marauder](https://github.com/justcallmekoko/ESP32Marauder) ⭐ 12,058 | 🐛 325 | 🌐 C++ | 📅 2026-08-22 - An integrated suite of offensive and defensive tools for WiFi and Bluetooth.
* [WiFiDuck](https://github.com/spacehuhn/WiFiDuck) ⭐ 3,269 | 🐛 22 | 🌐 C++ | 📅 2023-06-02 - A wireless-enabled keystroke injector, analogous, but even more awesome than the Rubber Ducky.
* [ESP8266 Beacon Spam](https://github.com/spacehuhn/esp8266_beaconSpam) ⭐ 1,363 | 🐛 25 | 🌐 C++ | 📅 2024-08-08 - Want to confuse people? This device creates hundreds of fake WiFi networks.
...
* [ESP32-Paxcounter](https://github.com/cyberman54/ESP32-Paxcounter#esp32-paxcounter) ⭐ 2,084 | 🐛 18 | 🌐 C++ | 📅 2026-08-12 - Wifi & Bluetooth driven, LoRaWAN enabled, battery powered mini Paxcounter built on cheap ESP32 LoRa IoT boards.
* [Disaster Radio](https://disaster.radio/) - A disaster-resilient communications network powered by the sun.

### Music and Audio

* [Squeezelite-esp32](https://github.com/sle118/squeezelite-esp32) ⭐ 2,167 | 🐛 89 | 🌐 C | 📅 2026-07-30 - Streaming audio receiver with multi-room sync, AirPlay, Bluetooth, hardware buttons, display and more.
...
* [DroneBridge](https://github.com/DroneBridge/ESP32) ⭐ 1,074 | 🐛 7 | 🌐 C | 📅 2026-08-20 - An implementation of DroneBridge, a signal link for drones and UAV's on the ESP32.
* [SoftRF](https://github.com/lyusupov/SoftRF) ⭐ 1,005 | 🐛 0 | 🌐 C | 📅 2026-08-21 - A DIY aviation proximity awareness system that can be used in UAV projects.
...
* [SmartSpin2k](https://github.com/doudar/SmartSpin2k) ⭐ 277 | 🐛 26 | 🌐 C++ | 📅 2026-08-21 - Transform your spin bike into a smart trainer with automatic resistance knob control in fitness apps like Zwift.
* [WLED](https://kno.wled.ge/) - Control many types of RGB(W) LED strips with an ESP8266 or ESP32 over WiFi.

## Libraries

* [Wasm3](https://github.com/wasm3/wasm3) ⭐ 7,991 | 🐛 38 | 🌐 C | 📅 2026-08-21 - A lightning fast WebAssembly interpreter designed for embedded devices, compatible with both ESP's.
...
* [LedFx](https://github.com/LedFx/LedFx) ⭐ 2,027 | 🐛 18 | 🌐 Python | 📅 2026-08-21 - A library for using audio input to create realtime light shows. LedFx can control multiple devices and works great with cheap ESP8266 nodes.
* [ESP32-audioI2S](https://github.com/schreibfaul1/ESP32-audioI2S) ⭐ 1,674 | 🐛 29 | 🌐 C | 📅 2026-08-21 - Plays mp3, m4a and wav files from SD card or stream via I2S interface.
