...
* [MicroPython](https://github.com/micropython/micropython/) ⭐ 22,007 | 🐛 1,539 | 🌐 C | 📅 2026-08-18 - An implemention of Python3 for the ESP8266 and 32.
* [RT-Thread](https://github.com/RT-Thread/rt-thread) ⭐ 12,163 | 🐛 479 | 🌐 C | 📅 2026-08-21 - Chinese open source firmware available for the ESP32.
...
* [Arduino Core/32](https://github.com/espressif/arduino-esp32) ⭐ 17,274 | 🐛 157 | 🌐 C++ | 📅 2026-08-23 - The other Arduino core for the ESP32.
* [Arduino Core/8266](https://github.com/esp8266/arduino) ⭐ 16,665 | 🐛 406 | 🌐 C++ | 📅 2026-07-29 - The Arduino core for the ESP8266.
* [PlatformIO](https://github.com/platformio/platformio-core) ⭐ 9,417 | 🐛 314 | 🌐 Python | 📅 2026-08-22 - Cross Platform IDE and Debugger that supports both the ESP32 and ESP8266.
* [ESPTool](https://github.com/espressif/esptool) ⭐ 6,452 | 🐛 16 | 🌐 Python | 📅 2026-08-20 - Espressif's command line tool for bootloader comms in both ESP's.
...
* [ESPEasy](https://github.com/letscontrolit/ESPEasy) ⭐ 3,567 | 🐛 380 | 🌐 C++ | 📅 2026-08-22 - Easily turn ESP modules into multifunction sensor devices for home automation systems.
...
* [ESP8266 Deauther](https://github.com/spacehuhn/esp8266_deauther) ⭐ 14,933 | 🐛 99 | 🌐 C | 📅 2024-08-14 - A very cool pseudojammer (deauther) of Wifi networks that uses the ESP8266.
* [ESP32Marauder](https://github.com/justcallmekoko/ESP32Marauder) ⭐ 12,074 | 🐛 326 | 🌐 C++ | 📅 2026-08-23 - An integrated suite of offensive and defensive tools for WiFi and Bluetooth.
...
* [Squeezelite-esp32](https://github.com/sle118/squeezelite-esp32) ⭐ 2,168 | 🐛 89 | 🌐 C | 📅 2026-07-30 - Streaming audio receiver with multi-room sync, AirPlay, Bluetooth, hardware buttons, display and more.
...
* [DroneBridge](https://github.com/DroneBridge/ESP32) ⭐ 1,075 | 🐛 7 | 🌐 C | 📅 2026-08-22 - An implementation of DroneBridge, a signal link for drones and UAV's on the ESP32.
...
* [Wasm3](https://github.com/wasm3/wasm3) ⭐ 7,992 | 🐛 38 | 🌐 C | 📅 2026-08-22 - A lightning fast WebAssembly interpreter designed for embedded devices, compatible with both ESP's.
* [IRremoteESP8266](https://github.com/markszabo/IRremoteESP8266) ⭐ 3,572 | 🐛 103 | 🌐 C++ | 📅 2026-08-14 - Emit and receive IR signals in the ESP8266.
...
* [LedFx](https://github.com/LedFx/LedFx) ⭐ 2,028 | 🐛 18 | 🌐 Python | 📅 2026-08-22 - A library for using audio input to create realtime light shows. LedFx can control multiple devices and works great with cheap ESP8266 nodes.
* [ESP32-audioI2S](https://github.com/schreibfaul1/ESP32-audioI2S) ⭐ 1,676 | 🐛 29 | 🌐 C | 📅 2026-08-22 - Plays mp3, m4a and wav files from SD card or stream via I2S interface.
