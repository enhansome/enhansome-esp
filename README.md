...
* [MicroPython](https://github.com/micropython/micropython/) ⭐ 21,991 | 🐛 1,536 | 🌐 C | 📅 2026-08-17 - An implemention of Python3 for the ESP8266 and 32.
* [RT-Thread](https://github.com/RT-Thread/rt-thread) ⭐ 12,156 | 🐛 481 | 🌐 C | 📅 2026-08-17 - Chinese open source firmware available for the ESP32.
...
* [Arduino Core/32](https://github.com/espressif/arduino-esp32) ⭐ 17,236 | 🐛 171 | 🌐 C++ | 📅 2026-08-16 - The other Arduino core for the ESP32.
* [Arduino Core/8266](https://github.com/esp8266/arduino) ⭐ 16,666 | 🐛 406 | 🌐 C++ | 📅 2026-07-29 - The Arduino core for the ESP8266.
...
* [ESPTool](https://github.com/espressif/esptool) ⭐ 6,444 | 🐛 13 | 🌐 Python | 📅 2026-08-10 - Espressif's command line tool for bootloader comms in both ESP's.
...
* [OpenMQTTGateway](https://github.com/1technophile/OpenMQTTGateway) ⭐ 4,076 | 🐛 51 | 🌐 C++ | 📅 2026-08-16 - An implementation of a multiprotocol MQTT gateway for both ESP's among other devices.
* [ESPEasy](https://github.com/letscontrolit/ESPEasy) ⭐ 3,561 | 🐛 386 | 🌐 C++ | 📅 2026-08-08 - Easily turn ESP modules into multifunction sensor devices for home automation systems.
...
* [ESP8266 Deauther](https://github.com/spacehuhn/esp8266_deauther) ⭐ 14,920 | 🐛 99 | 🌐 C | 📅 2024-08-14 - A very cool pseudojammer (deauther) of Wifi networks that uses the ESP8266.
* [ESP32Marauder](https://github.com/justcallmekoko/ESP32Marauder) ⭐ 11,996 | 🐛 322 | 🌐 C++ | 📅 2026-08-16 - An integrated suite of offensive and defensive tools for WiFi and Bluetooth.
* [WiFiDuck](https://github.com/spacehuhn/WiFiDuck) ⭐ 3,166 | 🐛 22 | 🌐 C++ | 📅 2023-06-02 - A wireless-enabled keystroke injector, analogous, but even more awesome than the Rubber Ducky.
* [ESP8266 Beacon Spam](https://github.com/spacehuhn/esp8266_beaconSpam) ⭐ 1,358 | 🐛 25 | 🌐 C++ | 📅 2024-08-08 - Want to confuse people? This device creates hundreds of fake WiFi networks.
...
* [Squeezelite-esp32](https://github.com/sle118/squeezelite-esp32) ⭐ 2,158 | 🐛 88 | 🌐 C | 📅 2026-07-30 - Streaming audio receiver with multi-room sync, AirPlay, Bluetooth, hardware buttons, display and more.
...
* [DroneBridge](https://github.com/DroneBridge/ESP32) ⭐ 1,003 | 🐛 8 | 🌐 C | 📅 2026-08-16 - An implementation of DroneBridge, a signal link for drones and UAV's on the ESP32.
* [SoftRF](https://github.com/lyusupov/SoftRF) ⭐ 1,002 | 🐛 0 | 🌐 C | 📅 2026-08-15 - A DIY aviation proximity awareness system that can be used in UAV projects.
...
* [Wasm3](https://github.com/wasm3/wasm3) ⭐ 7,974 | 🐛 66 | 🌐 C | 📅 2026-08-16 - A lightning fast WebAssembly interpreter designed for embedded devices, compatible with both ESP's.
...
* [HomeSpan](https://github.com/HomeSpan/HomeSpan) ⭐ 2,148 | 🐛 9 | 🌐 C++ | 📅 2026-08-16 - A robust and extremely easy-to-use Arduino library for creating your own ESP32-based HomeKit devices.
...
* [LedFx](https://github.com/LedFx/LedFx) ⭐ 2,021 | 🐛 16 | 🌐 Python | 📅 2026-08-10 - A library for using audio input to create realtime light shows. LedFx can control multiple devices and works great with cheap ESP8266 nodes.
* [ESP32-audioI2S](https://github.com/schreibfaul1/ESP32-audioI2S) ⭐ 1,667 | 🐛 31 | 🌐 C | 📅 2026-08-16 - Plays mp3, m4a and wav files from SD card or stream via I2S interface.
* [ESP-Dash](https://github.com/ayushsharma82/ESP-DASH) ⭐ 1,397 | 🐛 0 | 🌐 C++ | 📅 2025-11-22 - Beautiful and fast framework for creating remote dashboards in the 8266/32. No internet required.
