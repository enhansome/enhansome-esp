...
* [MicroPython](https://github.com/micropython/micropython/) ⭐ 22,077 | 🐛 1,525 | 🌐 C | 📅 2026-09-21 - An implemention of Python3 for the ESP8266 and 32.
* [RT-Thread](https://github.com/RT-Thread/rt-thread) ⭐ 12,226 | 🐛 482 | 🌐 C | 📅 2026-09-21 - Chinese open source firmware available for the ESP32.
...
* [Arduino Core/32](https://github.com/espressif/arduino-esp32) ⭐ 17,417 | 🐛 158 | 🌐 C++ | 📅 2026-09-22 - The other Arduino core for the ESP32.
* [Arduino Core/8266](https://github.com/esp8266/arduino) ⭐ 16,688 | 🐛 405 | 🌐 C++ | 📅 2026-08-27 - The Arduino core for the ESP8266.
* [PlatformIO](https://github.com/platformio/platformio-core) ⭐ 9,476 | 🐛 272 | 🌐 Python | 📅 2026-09-19 - Cross Platform IDE and Debugger that supports both the ESP32 and ESP8266.
* [ESPTool](https://github.com/espressif/esptool) ⭐ 6,485 | 🐛 14 | 🌐 Python | 📅 2026-09-21 - Espressif's command line tool for bootloader comms in both ESP's.
* [Tuya-Convert](https://github.com/ct-Open-Source/tuya-convert) ⭐ 5,076 | 🐛 215 | 🌐 Python | 📅 2024-09-06 - A Wi-Fi firmware flasher ESP8266 that has been pre-loaded with Tuya firmware.
...
* [OpenMQTTGateway](https://github.com/1technophile/OpenMQTTGateway) ⭐ 4,096 | 🐛 48 | 🌐 C++ | 📅 2026-09-21 - An implementation of a multiprotocol MQTT gateway for both ESP's among other devices.
* [ESPEasy](https://github.com/letscontrolit/ESPEasy) ⭐ 3,606 | 🐛 386 | 🌐 C++ | 📅 2026-09-21 - Easily turn ESP modules into multifunction sensor devices for home automation systems.
...
* [ESP32Marauder](https://github.com/justcallmekoko/ESP32Marauder) ⭐ 12,420 | 🐛 334 | 🌐 C++ | 📅 2026-09-17 - An integrated suite of offensive and defensive tools for WiFi and Bluetooth.
...
* [ESP32-Paxcounter](https://github.com/cyberman54/ESP32-Paxcounter#esp32-paxcounter) ⭐ 2,095 | 🐛 18 | 🌐 C++ | 📅 2026-08-12 - Wifi & Bluetooth driven, LoRaWAN enabled, battery powered mini Paxcounter built on cheap ESP32 LoRa IoT boards.
...
* [Squeezelite-esp32](https://github.com/sle118/squeezelite-esp32) ⭐ 2,200 | 🐛 97 | 🌐 C | 📅 2026-07-30 - Streaming audio receiver with multi-room sync, AirPlay, Bluetooth, hardware buttons, display and more.
...
* [DroneBridge](https://github.com/DroneBridge/ESP32) ⭐ 1,104 | 🐛 7 | 🌐 C | 📅 2026-09-12 - An implementation of DroneBridge, a signal link for drones and UAV's on the ESP32.
* [SoftRF](https://github.com/lyusupov/SoftRF) ⭐ 1,022 | 🐛 0 | 🌐 C | 📅 2026-09-21 - A DIY aviation proximity awareness system that can be used in UAV projects.
...
* [SmartSpin2k](https://github.com/doudar/SmartSpin2k) ⭐ 283 | 🐛 28 | 🌐 C++ | 📅 2026-09-21 - Transform your spin bike into a smart trainer with automatic resistance knob control in fitness apps like Zwift.
...
* [IRremoteESP8266](https://github.com/markszabo/IRremoteESP8266) ⭐ 3,603 | 🐛 107 | 🌐 C++ | 📅 2026-08-23 - Emit and receive IR signals in the ESP8266.
...
* [LedFx](https://github.com/LedFx/LedFx) ⭐ 2,054 | 🐛 19 | 🌐 Python | 📅 2026-09-21 - A library for using audio input to create realtime light shows. LedFx can control multiple devices and works great with cheap ESP8266 nodes.
* [ESP32-audioI2S](https://github.com/schreibfaul1/ESP32-audioI2S) ⭐ 1,695 | 🐛 12 | 🌐 C | 📅 2026-09-21 - Plays mp3, m4a and wav files from SD card or stream via I2S interface.
