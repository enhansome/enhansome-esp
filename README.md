...
* [MicroPython](https://github.com/micropython/micropython/) ⭐ 22,068 | 🐛 1,531 | 🌐 C | 📅 2026-09-16 - An implemention of Python3 for the ESP8266 and 32.
* [RT-Thread](https://github.com/RT-Thread/rt-thread) ⭐ 12,223 | 🐛 489 | 🌐 C | 📅 2026-09-17 - Chinese open source firmware available for the ESP32.
...
* [Arduino Core/32](https://github.com/espressif/arduino-esp32) ⭐ 17,390 | 🐛 145 | 🌐 C++ | 📅 2026-09-17 - The other Arduino core for the ESP32.
* [Arduino Core/8266](https://github.com/esp8266/arduino) ⭐ 16,685 | 🐛 405 | 🌐 C++ | 📅 2026-08-27 - The Arduino core for the ESP8266.
* [PlatformIO](https://github.com/platformio/platformio-core) ⭐ 9,462 | 🐛 276 | 🌐 Python | 📅 2026-09-15 - Cross Platform IDE and Debugger that supports both the ESP32 and ESP8266.
* [ESPTool](https://github.com/espressif/esptool) ⭐ 6,479 | 🐛 14 | 🌐 Python | 📅 2026-09-17 - Espressif's command line tool for bootloader comms in both ESP's.
...
* [ESPEasy](https://github.com/letscontrolit/ESPEasy) ⭐ 3,604 | 🐛 384 | 🌐 C++ | 📅 2026-09-16 - Easily turn ESP modules into multifunction sensor devices for home automation systems.
...
* [ESP8266 Deauther](https://github.com/spacehuhn/esp8266_deauther) ⭐ 14,976 | 🐛 99 | 🌐 C | 📅 2024-08-14 - A very cool pseudojammer (deauther) of Wifi networks that uses the ESP8266.
* [ESP32Marauder](https://github.com/justcallmekoko/ESP32Marauder) ⭐ 12,377 | 🐛 327 | 🌐 C++ | 📅 2026-09-17 - An integrated suite of offensive and defensive tools for WiFi and Bluetooth.
...
* [ESP8266 Beacon Spam](https://github.com/spacehuhn/esp8266_beaconSpam) ⭐ 1,371 | 🐛 25 | 🌐 C++ | 📅 2024-08-08 - Want to confuse people? This device creates hundreds of fake WiFi networks.
...
* [ESP32-Paxcounter](https://github.com/cyberman54/ESP32-Paxcounter#esp32-paxcounter) ⭐ 2,092 | 🐛 18 | 🌐 C++ | 📅 2026-08-12 - Wifi & Bluetooth driven, LoRaWAN enabled, battery powered mini Paxcounter built on cheap ESP32 LoRa IoT boards.
...
* [Squeezelite-esp32](https://github.com/sle118/squeezelite-esp32) ⭐ 2,193 | 🐛 96 | 🌐 C | 📅 2026-07-30 - Streaming audio receiver with multi-room sync, AirPlay, Bluetooth, hardware buttons, display and more.
...
* [ESPuino](https://github.com/biologist79/ESPuino) ⭐ 423 | 🐛 3 | 🌐 C++ | 📅 2026-09-16 - RFID-controlled music player powered by ESP32.
...
* [SmartSpin2k](https://github.com/doudar/SmartSpin2k) ⭐ 280 | 🐛 27 | 🌐 C++ | 📅 2026-09-17 - Transform your spin bike into a smart trainer with automatic resistance knob control in fitness apps like Zwift.
* [WLED](https://kno.wled.ge/) - Control many types of RGB(W) LED strips with an ESP8266 or ESP32 over WiFi.

## Libraries

* [Wasm3](https://github.com/wasm3/wasm3) ⭐ 8,027 | 🐛 18 | 🌐 C | 📅 2026-09-15 - A lightning fast WebAssembly interpreter designed for embedded devices, compatible with both ESP's.
* [IRremoteESP8266](https://github.com/markszabo/IRremoteESP8266) ⭐ 3,599 | 🐛 107 | 🌐 C++ | 📅 2026-08-23 - Emit and receive IR signals in the ESP8266.
...
* [HomeSpan](https://github.com/HomeSpan/HomeSpan) ⭐ 2,164 | 🐛 9 | 🌐 C++ | 📅 2026-09-15 - A robust and extremely easy-to-use Arduino library for creating your own ESP32-based HomeKit devices.
...
* [ESP32-audioI2S](https://github.com/schreibfaul1/ESP32-audioI2S) ⭐ 1,694 | 🐛 12 | 🌐 C | 📅 2026-09-15 - Plays mp3, m4a and wav files from SD card or stream via I2S interface.
