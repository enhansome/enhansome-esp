...
* [MicroPython](https://github.com/micropython/micropython/) ⭐ 22,042 | 🐛 1,528 | 🌐 C | 📅 2026-09-04 - An implemention of Python3 for the ESP8266 and 32.
* [RT-Thread](https://github.com/RT-Thread/rt-thread) ⭐ 12,188 | 🐛 493 | 🌐 C | 📅 2026-09-03 - Chinese open source firmware available for the ESP32.
...
* [Arduino Core/32](https://github.com/espressif/arduino-esp32) ⭐ 17,314 | 🐛 161 | 🌐 C++ | 📅 2026-09-03 - The other Arduino core for the ESP32.
* [Arduino Core/8266](https://github.com/esp8266/arduino) ⭐ 16,673 | 🐛 404 | 🌐 C++ | 📅 2026-08-27 - The Arduino core for the ESP8266.
* [PlatformIO](https://github.com/platformio/platformio-core) ⭐ 9,437 | 🐛 313 | 🌐 Python | 📅 2026-09-03 - Cross Platform IDE and Debugger that supports both the ESP32 and ESP8266.
...
* [ESPEasy](https://github.com/letscontrolit/ESPEasy) ⭐ 3,594 | 🐛 386 | 🌐 C++ | 📅 2026-09-01 - Easily turn ESP modules into multifunction sensor devices for home automation systems.
...
* [ESP32Marauder](https://github.com/justcallmekoko/ESP32Marauder) ⭐ 12,212 | 🐛 327 | 🌐 C++ | 📅 2026-09-04 - An integrated suite of offensive and defensive tools for WiFi and Bluetooth.
...
* [SoftRF](https://github.com/lyusupov/SoftRF) ⭐ 1,010 | 🐛 0 | 🌐 C | 📅 2026-09-04 - A DIY aviation proximity awareness system that can be used in UAV projects.
...
* [SmartSpin2k](https://github.com/doudar/SmartSpin2k) ⭐ 278 | 🐛 27 | 🌐 C++ | 📅 2026-09-04 - Transform your spin bike into a smart trainer with automatic resistance knob control in fitness apps like Zwift.
* [WLED](https://kno.wled.ge/) - Control many types of RGB(W) LED strips with an ESP8266 or ESP32 over WiFi.

## Libraries

* [Wasm3](https://github.com/wasm3/wasm3) ⭐ 8,017 | 🐛 19 | 🌐 C | 📅 2026-09-03 - A lightning fast WebAssembly interpreter designed for embedded devices, compatible with both ESP's.
* [IRremoteESP8266](https://github.com/markszabo/IRremoteESP8266) ⭐ 3,585 | 🐛 103 | 🌐 C++ | 📅 2026-08-23 - Emit and receive IR signals in the ESP8266.
...
* [HomeSpan](https://github.com/HomeSpan/HomeSpan) ⭐ 2,157 | 🐛 9 | 🌐 C++ | 📅 2026-09-01 - A robust and extremely easy-to-use Arduino library for creating your own ESP32-based HomeKit devices.
...
* [LedFx](https://github.com/LedFx/LedFx) ⭐ 2,037 | 🐛 17 | 🌐 Python | 📅 2026-08-31 - A library for using audio input to create realtime light shows. LedFx can control multiple devices and works great with cheap ESP8266 nodes.
* [ESP32-audioI2S](https://github.com/schreibfaul1/ESP32-audioI2S) ⭐ 1,687 | 🐛 15 | 🌐 C | 📅 2026-09-03 - Plays mp3, m4a and wav files from SD card or stream via I2S interface.
