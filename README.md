...
* [MicroPython](https://github.com/micropython/micropython/) ⭐ 22,052 | 🐛 1,522 | 🌐 C | 📅 2026-09-09 - An implemention of Python3 for the ESP8266 and 32.
* [RT-Thread](https://github.com/RT-Thread/rt-thread) ⭐ 12,204 | 🐛 493 | 🌐 C | 📅 2026-09-09 - Chinese open source firmware available for the ESP32.
...
* [Arduino Core/32](https://github.com/espressif/arduino-esp32) ⭐ 17,347 | 🐛 171 | 🌐 C++ | 📅 2026-09-09 - The other Arduino core for the ESP32.
* [Arduino Core/8266](https://github.com/esp8266/arduino) ⭐ 16,678 | 🐛 404 | 🌐 C++ | 📅 2026-08-27 - The Arduino core for the ESP8266.
* [PlatformIO](https://github.com/platformio/platformio-core) ⭐ 9,449 | 🐛 277 | 🌐 Python | 📅 2026-09-07 - Cross Platform IDE and Debugger that supports both the ESP32 and ESP8266.
...
* [ESPEasy](https://github.com/letscontrolit/ESPEasy) ⭐ 3,602 | 🐛 387 | 🌐 C++ | 📅 2026-09-01 - Easily turn ESP modules into multifunction sensor devices for home automation systems.
...
* [ESP8266 Deauther](https://github.com/spacehuhn/esp8266_deauther) ⭐ 14,963 | 🐛 99 | 🌐 C | 📅 2024-08-14 - A very cool pseudojammer (deauther) of Wifi networks that uses the ESP8266.
* [ESP32Marauder](https://github.com/justcallmekoko/ESP32Marauder) ⭐ 12,271 | 🐛 327 | 🌐 C++ | 📅 2026-09-09 - An integrated suite of offensive and defensive tools for WiFi and Bluetooth.
...
* [ESP32-Paxcounter](https://github.com/cyberman54/ESP32-Paxcounter#esp32-paxcounter) ⭐ 2,089 | 🐛 18 | 🌐 C++ | 📅 2026-08-12 - Wifi & Bluetooth driven, LoRaWAN enabled, battery powered mini Paxcounter built on cheap ESP32 LoRa IoT boards.
...
* [Squeezelite-esp32](https://github.com/sle118/squeezelite-esp32) ⭐ 2,189 | 🐛 91 | 🌐 C | 📅 2026-07-30 - Streaming audio receiver with multi-room sync, AirPlay, Bluetooth, hardware buttons, display and more.
...
* [ESPuino](https://github.com/biologist79/ESPuino) ⭐ 419 | 🐛 1 | 🌐 C++ | 📅 2026-09-07 - RFID-controlled music player powered by ESP32.
...
* [DroneBridge](https://github.com/DroneBridge/ESP32) ⭐ 1,090 | 🐛 7 | 🌐 C | 📅 2026-08-26 - An implementation of DroneBridge, a signal link for drones and UAV's on the ESP32.
...
* [IRremoteESP8266](https://github.com/markszabo/IRremoteESP8266) ⭐ 3,593 | 🐛 103 | 🌐 C++ | 📅 2026-08-23 - Emit and receive IR signals in the ESP8266.
...
* [HomeSpan](https://github.com/HomeSpan/HomeSpan) ⭐ 2,159 | 🐛 9 | 🌐 C++ | 📅 2026-09-05 - A robust and extremely easy-to-use Arduino library for creating your own ESP32-based HomeKit devices.
...
* [ESP32-audioI2S](https://github.com/schreibfaul1/ESP32-audioI2S) ⭐ 1,690 | 🐛 17 | 🌐 C | 📅 2026-09-07 - Plays mp3, m4a and wav files from SD card or stream via I2S interface.
