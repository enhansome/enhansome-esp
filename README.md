...
* [MicroPython](https://github.com/micropython/micropython/) ⭐ 22,067 | 🐛 1,527 | 🌐 C | 📅 2026-09-16 - An implemention of Python3 for the ESP8266 and 32.
* [RT-Thread](https://github.com/RT-Thread/rt-thread) ⭐ 12,221 | 🐛 487 | 🌐 C | 📅 2026-09-16 - Chinese open source firmware available for the ESP32.
...
* [Arduino Core/32](https://github.com/espressif/arduino-esp32) ⭐ 17,385 | 🐛 158 | 🌐 C++ | 📅 2026-09-16 - The other Arduino core for the ESP32.
* [Arduino Core/8266](https://github.com/esp8266/arduino) ⭐ 16,684 | 🐛 405 | 🌐 C++ | 📅 2026-08-27 - The Arduino core for the ESP8266.
* [PlatformIO](https://github.com/platformio/platformio-core) ⭐ 9,458 | 🐛 276 | 🌐 Python | 📅 2026-09-15 - Cross Platform IDE and Debugger that supports both the ESP32 and ESP8266.
* [ESPTool](https://github.com/espressif/esptool) ⭐ 6,479 | 🐛 14 | 🌐 Python | 📅 2026-09-15 - Espressif's command line tool for bootloader comms in both ESP's.
...
* [OpenMQTTGateway](https://github.com/1technophile/OpenMQTTGateway) ⭐ 4,096 | 🐛 47 | 🌐 C++ | 📅 2026-09-14 - An implementation of a multiprotocol MQTT gateway for both ESP's among other devices.
* [ESPEasy](https://github.com/letscontrolit/ESPEasy) ⭐ 3,603 | 🐛 385 | 🌐 C++ | 📅 2026-09-14 - Easily turn ESP modules into multifunction sensor devices for home automation systems.
...
* [ESP32Marauder](https://github.com/justcallmekoko/ESP32Marauder) ⭐ 12,372 | 🐛 327 | 🌐 C++ | 📅 2026-09-16 - An integrated suite of offensive and defensive tools for WiFi and Bluetooth.
...
* [Squeezelite-esp32](https://github.com/sle118/squeezelite-esp32) ⭐ 2,192 | 🐛 95 | 🌐 C | 📅 2026-07-30 - Streaming audio receiver with multi-room sync, AirPlay, Bluetooth, hardware buttons, display and more.
...
* [ESPuino](https://github.com/biologist79/ESPuino) ⭐ 423 | 🐛 2 | 🌐 C++ | 📅 2026-09-15 - RFID-controlled music player powered by ESP32.
...
* [SmartSpin2k](https://github.com/doudar/SmartSpin2k) ⭐ 280 | 🐛 27 | 🌐 C++ | 📅 2026-09-15 - Transform your spin bike into a smart trainer with automatic resistance knob control in fitness apps like Zwift.
...
* [IRremoteESP8266](https://github.com/markszabo/IRremoteESP8266) ⭐ 3,600 | 🐛 105 | 🌐 C++ | 📅 2026-08-23 - Emit and receive IR signals in the ESP8266.
...
* [HomeSpan](https://github.com/HomeSpan/HomeSpan) ⭐ 2,163 | 🐛 9 | 🌐 C++ | 📅 2026-09-15 - A robust and extremely easy-to-use Arduino library for creating your own ESP32-based HomeKit devices.
...
* [ESP32-audioI2S](https://github.com/schreibfaul1/ESP32-audioI2S) ⭐ 1,694 | 🐛 13 | 🌐 C | 📅 2026-09-15 - Plays mp3, m4a and wav files from SD card or stream via I2S interface.
