...
* [MicroPython](https://github.com/micropython/micropython/) ⭐ 22,038 | 🐛 1,532 | 🌐 C | 📅 2026-09-03 - An implemention of Python3 for the ESP8266 and 32.
* [RT-Thread](https://github.com/RT-Thread/rt-thread) ⭐ 12,189 | 🐛 493 | 🌐 C | 📅 2026-09-03 - Chinese open source firmware available for the ESP32.
...
* [Arduino Core/32](https://github.com/espressif/arduino-esp32) ⭐ 17,312 | 🐛 159 | 🌐 C++ | 📅 2026-09-02 - The other Arduino core for the ESP32.
* [Arduino Core/8266](https://github.com/esp8266/arduino) ⭐ 16,673 | 🐛 404 | 🌐 C++ | 📅 2026-08-27 - The Arduino core for the ESP8266.
* [PlatformIO](https://github.com/platformio/platformio-core) ⭐ 9,435 | 🐛 313 | 🌐 Python | 📅 2026-08-28 - Cross Platform IDE and Debugger that supports both the ESP32 and ESP8266.
* [ESPTool](https://github.com/espressif/esptool) ⭐ 6,466 | 🐛 14 | 🌐 Python | 📅 2026-09-02 - Espressif's command line tool for bootloader comms in both ESP's.
...
* [CanAirIO](https://github.com/kike-canaries/canairio_firmware#canairio-firmware) ⭐ 128 | 🐛 29 | 🌐 C++ | 📅 2026-09-02 - Citizen science project that uses mobile and fixed stations to measure air quality with ESP32 and smartphones.
...
* [ESP8266 Deauther](https://github.com/spacehuhn/esp8266_deauther) ⭐ 14,952 | 🐛 99 | 🌐 C | 📅 2024-08-14 - A very cool pseudojammer (deauther) of Wifi networks that uses the ESP8266.
* [ESP32Marauder](https://github.com/justcallmekoko/ESP32Marauder) ⭐ 12,200 | 🐛 329 | 🌐 C++ | 📅 2026-08-29 - An integrated suite of offensive and defensive tools for WiFi and Bluetooth.
* [WiFiDuck](https://github.com/spacehuhn/WiFiDuck) ⭐ 3,285 | 🐛 22 | 🌐 C++ | 📅 2023-06-02 - A wireless-enabled keystroke injector, analogous, but even more awesome than the Rubber Ducky.
...
* [PedalinoMini](https://github.com/alf45tar/PedalinoMini) ⭐ 615 | 🐛 48 | 🌐 Python | 📅 2026-05-04 - A wireless MIDI pedal controller for guitarists, built with the ESP32.
* [ESPuino](https://github.com/biologist79/ESPuino) ⭐ 418 | 🐛 2 | 🌐 C++ | 📅 2026-09-03 - RFID-controlled music player powered by ESP32.
...
* [DroneBridge](https://github.com/DroneBridge/ESP32) ⭐ 1,080 | 🐛 6 | 🌐 C | 📅 2026-08-26 - An implementation of DroneBridge, a signal link for drones and UAV's on the ESP32.
* [SoftRF](https://github.com/lyusupov/SoftRF) ⭐ 1,010 | 🐛 0 | 🌐 C | 📅 2026-09-03 - A DIY aviation proximity awareness system that can be used in UAV projects.
* [Retro ESP32](https://github.com/retro-esp32/RetroESP32) ⭐ 726 | 🐛 21 | 🌐 C | 📅 2024-07-31 - An extremely cool launcher for the Odroid Go (with the ESP32), which allows emulating several retro consoles.
...
* [SmartSpin2k](https://github.com/doudar/SmartSpin2k) ⭐ 278 | 🐛 27 | 🌐 C++ | 📅 2026-09-01 - Transform your spin bike into a smart trainer with automatic resistance knob control in fitness apps like Zwift.
* [WLED](https://kno.wled.ge/) - Control many types of RGB(W) LED strips with an ESP8266 or ESP32 over WiFi.

## Libraries

* [Wasm3](https://github.com/wasm3/wasm3) ⭐ 8,015 | 🐛 19 | 🌐 C | 📅 2026-09-03 - A lightning fast WebAssembly interpreter designed for embedded devices, compatible with both ESP's.
...
* [HomeSpan](https://github.com/HomeSpan/HomeSpan) ⭐ 2,156 | 🐛 9 | 🌐 C++ | 📅 2026-09-01 - A robust and extremely easy-to-use Arduino library for creating your own ESP32-based HomeKit devices.
...
* [ESP32-audioI2S](https://github.com/schreibfaul1/ESP32-audioI2S) ⭐ 1,686 | 🐛 15 | 🌐 C | 📅 2026-09-02 - Plays mp3, m4a and wav files from SD card or stream via I2S interface.
* [ESP-Dash](https://github.com/ayushsharma82/ESP-DASH) ⭐ 1,400 | 🐛 0 | 🌐 C++ | 📅 2025-11-22 - Beautiful and fast framework for creating remote dashboards in the 8266/32. No internet required.
