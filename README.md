...
* [MicroPython](https://github.com/micropython/micropython/) ⭐ 22,093 | 🐛 1,529 | 🌐 C | 📅 2026-09-21 - An implemention of Python3 for the ESP8266 and 32.
* [RT-Thread](https://github.com/RT-Thread/rt-thread) ⭐ 12,246 | 🐛 500 | 🌐 C | 📅 2026-09-25 - Chinese open source firmware available for the ESP32.
...
* [Arduino Core/32](https://github.com/espressif/arduino-esp32) ⭐ 17,433 | 🐛 139 | 🌐 C++ | 📅 2026-09-26 - The other Arduino core for the ESP32.
* [Arduino Core/8266](https://github.com/esp8266/arduino) ⭐ 16,687 | 🐛 406 | 🌐 C++ | 📅 2026-08-27 - The Arduino core for the ESP8266.
* [PlatformIO](https://github.com/platformio/platformio-core) ⭐ 9,483 | 🐛 275 | 🌐 Python | 📅 2026-09-23 - Cross Platform IDE and Debugger that supports both the ESP32 and ESP8266.
* [ESPTool](https://github.com/espressif/esptool) ⭐ 6,494 | 🐛 15 | 🌐 Python | 📅 2026-09-25 - Espressif's command line tool for bootloader comms in both ESP's.
...
* [ESP8266 Deauther](https://github.com/spacehuhn/esp8266_deauther) ⭐ 14,999 | 🐛 101 | 🌐 C | 📅 2024-08-14 - A very cool pseudojammer (deauther) of Wifi networks that uses the ESP8266.
* [ESP32Marauder](https://github.com/justcallmekoko/ESP32Marauder) ⭐ 12,471 | 🐛 333 | 🌐 C++ | 📅 2026-09-17 - An integrated suite of offensive and defensive tools for WiFi and Bluetooth.
* [WiFiDuck](https://github.com/spacehuhn/WiFiDuck) ⭐ 3,309 | 🐛 22 | 🌐 C++ | 📅 2023-06-02 - A wireless-enabled keystroke injector, analogous, but even more awesome than the Rubber Ducky.
...
* [ESP32-Paxcounter](https://github.com/cyberman54/ESP32-Paxcounter#esp32-paxcounter) ⭐ 2,097 | 🐛 18 | 🌐 C++ | 📅 2026-08-12 - Wifi & Bluetooth driven, LoRaWAN enabled, battery powered mini Paxcounter built on cheap ESP32 LoRa IoT boards.
...
* [Squeezelite-esp32](https://github.com/sle118/squeezelite-esp32) ⭐ 2,204 | 🐛 97 | 🌐 C | 📅 2026-07-30 - Streaming audio receiver with multi-room sync, AirPlay, Bluetooth, hardware buttons, display and more.
...
* [SoftRF](https://github.com/lyusupov/SoftRF) ⭐ 1,025 | 🐛 0 | 🌐 C | 📅 2026-09-26 - A DIY aviation proximity awareness system that can be used in UAV projects.
...
* [Wasm3](https://github.com/wasm3/wasm3) ⭐ 8,034 | 🐛 18 | 🌐 C | 📅 2026-09-25 - A lightning fast WebAssembly interpreter designed for embedded devices, compatible with both ESP's.
...
* [TinyGSM](https://github.com/vshymanskyy/TinyGSM) ⭐ 2,219 | 🐛 354 | 🌐 C++ | 📅 2026-07-21 - A quick and simple Arduino library for interaction with GSM modules which can also control the 8266 through AT commands.
...
* [LedFx](https://github.com/LedFx/LedFx) ⭐ 2,061 | 🐛 22 | 🌐 Python | 📅 2026-09-21 - A library for using audio input to create realtime light shows. LedFx can control multiple devices and works great with cheap ESP8266 nodes.
