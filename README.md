...
* [MicroPython](https://github.com/micropython/micropython/) ⭐ 21,988 | 🐛 1,533 | 🌐 C | 📅 2026-08-18 - An implemention of Python3 for the ESP8266 and 32.
* [RT-Thread](https://github.com/RT-Thread/rt-thread) ⭐ 12,157 | 🐛 480 | 🌐 C | 📅 2026-08-17 - Chinese open source firmware available for the ESP32.
* [NodeMCU](https://github.com/nodemcu/nodemcu-firmware) ⭐ 7,941 | 🐛 119 | 🌐 C | 📅 2026-06-07 - An eLua-based firmware for the ESP8266.
...
* [ESP3D](https://github.com/luc-github/ESP3D) ⭐ 1,989 | 🐛 5 | 🌐 C | 📅 2026-07-22 - An experimental firmware for 3D Printers, both the ESP32 and 8266.
...
* [Arduino Core/32](https://github.com/espressif/arduino-esp32) ⭐ 17,243 | 🐛 175 | 🌐 C++ | 📅 2026-08-16 - The other Arduino core for the ESP32.
* [Arduino Core/8266](https://github.com/esp8266/arduino) ⭐ 16,667 | 🐛 406 | 🌐 C++ | 📅 2026-07-29 - The Arduino core for the ESP8266.
* [PlatformIO](https://github.com/platformio/platformio-core) ⭐ 9,406 | 🐛 317 | 🌐 Python | 📅 2026-08-11 - Cross Platform IDE and Debugger that supports both the ESP32 and ESP8266.
* [ESPTool](https://github.com/espressif/esptool) ⭐ 6,447 | 🐛 14 | 🌐 Python | 📅 2026-08-10 - Espressif's command line tool for bootloader comms in both ESP's.
* [Tuya-Convert](https://github.com/ct-Open-Source/tuya-convert) ⭐ 5,072 | 🐛 215 | 🌐 Python | 📅 2024-09-06 - A Wi-Fi firmware flasher ESP8266 that has been pre-loaded with Tuya firmware.
* [NodeMCU Flasher](https://github.com/nodemcu/nodemcu-flasher) ⭐ 2,214 | 🐛 47 | 🌐 Pascal | 📅 2017-08-08 - The official flashing tool for the NodeMCU OS.
* [ESP-Open-SDK](https://github.com/pfalcon/esp-open-sdk) ⭐ 1,988 | 🐛 139 | 🌐 Makefile | 📅 2022-01-12 - An open SDK for the ESP8266.
* [Tasmotizer](https://github.com/tasmota/tasmotizer) ⭐ 1,539 | 🐛 38 | 🌐 Python | 📅 2024-01-30 - A graphical flashing tool for Tasmota firmware. Can manage Wi-Fi & MQTT settings, modules & templates.
* [LuaNode](https://github.com/Nicholas3388/LuaNode) ⭐ 1,330 | 🐛 36 | 🌐 C | 📅 2024-05-30 - A lua-only SDK for 32/8266.
...
* [OpenMQTTGateway](https://github.com/1technophile/OpenMQTTGateway) ⭐ 4,076 | 🐛 50 | 🌐 C++ | 📅 2026-08-17 - An implementation of a multiprotocol MQTT gateway for both ESP's among other devices.
* [ESPEasy](https://github.com/letscontrolit/ESPEasy) ⭐ 3,563 | 🐛 384 | 🌐 C++ | 📅 2026-08-17 - Easily turn ESP modules into multifunction sensor devices for home automation systems.
...
* [HomePoint](https://github.com/sieren/Homepoint) ⭐ 660 | 🐛 29 | 🌐 C | 📅 2022-08-04 - Control MQTT/HomeKit smart home devices from an ESP32-powered screen.
* [SuperGreenOS](https://github.com/supergreenlab/SuperGreenOS) ⭐ 220 | 🐛 1 | 🌐 C | 📅 2024-06-05 - A full-featured home farming automation software for the ESP32.
...
* [ESP8266 Deauther](https://github.com/spacehuhn/esp8266_deauther) ⭐ 14,922 | 🐛 99 | 🌐 C | 📅 2024-08-14 - A very cool pseudojammer (deauther) of Wifi networks that uses the ESP8266.
* [ESP32Marauder](https://github.com/justcallmekoko/ESP32Marauder) ⭐ 12,014 | 🐛 324 | 🌐 C++ | 📅 2026-08-17 - An integrated suite of offensive and defensive tools for WiFi and Bluetooth.
* [WiFiDuck](https://github.com/spacehuhn/WiFiDuck) ⭐ 3,215 | 🐛 22 | 🌐 C++ | 📅 2023-06-02 - A wireless-enabled keystroke injector, analogous, but even more awesome than the Rubber Ducky.
* [ESP8266 Beacon Spam](https://github.com/spacehuhn/esp8266_beaconSpam) ⭐ 1,359 | 🐛 25 | 🌐 C++ | 📅 2024-08-08 - Want to confuse people? This device creates hundreds of fake WiFi networks.
* [DeauthDetector](https://github.com/spacehuhn/DeauthDetector) ⭐ 971 | 🐛 19 | 🌐 C++ | 📅 2023-08-28 - A small device that shines a light if it detects a WiFi deauth attack. Made by the same guy as the last six projects.
...
* [ESP32-BLECollector](https://github.com/tobozo/ESP32-BLECollector) ⭐ 360 | 🐛 1 | 🌐 C | 📅 2024-09-04 - A wardriving device which displays BLE devices and collects data from them, all in a nice screen interface.
...
* [ESP32-Paxcounter](https://github.com/cyberman54/ESP32-Paxcounter#esp32-paxcounter) ⭐ 2,081 | 🐛 18 | 🌐 C++ | 📅 2026-08-12 - Wifi & Bluetooth driven, LoRaWAN enabled, battery powered mini Paxcounter built on cheap ESP32 LoRa IoT boards.
* [Disaster Radio](https://disaster.radio/) - A disaster-resilient communications network powered by the sun.

### Music and Audio

* [Squeezelite-esp32](https://github.com/sle118/squeezelite-esp32) ⭐ 2,160 | 🐛 88 | 🌐 C | 📅 2026-07-30 - Streaming audio receiver with multi-room sync, AirPlay, Bluetooth, hardware buttons, display and more.
...
* [ESPuino](https://github.com/biologist79/ESPuino) ⭐ 417 | 🐛 3 | 🌐 C++ | 📅 2026-08-16 - RFID-controlled music player powered by ESP32.
...
* [ThingPulse esp8266-spotify-remote](https://github.com/ThingPulse/esp8266-spotify-remote) ⭐ 277 | 🐛 1 | 🌐 C | 📅 2023-09-30 - Control your Spotify player from a ESP8266 with color touch display.
...
* [DroneBridge](https://github.com/DroneBridge/ESP32) ⭐ 1,005 | 🐛 8 | 🌐 C | 📅 2026-08-17 - An implementation of DroneBridge, a signal link for drones and UAV's on the ESP32.
* [SoftRF](https://github.com/lyusupov/SoftRF) ⭐ 1,002 | 🐛 0 | 🌐 C | 📅 2026-08-17 - A DIY aviation proximity awareness system that can be used in UAV projects.
...
* [SmartSpin2k](https://github.com/doudar/SmartSpin2k) ⭐ 277 | 🐛 26 | 🌐 C++ | 📅 2026-08-15 - Transform your spin bike into a smart trainer with automatic resistance knob control in fitness apps like Zwift.
* [WLED](https://kno.wled.ge/) - Control many types of RGB(W) LED strips with an ESP8266 or ESP32 over WiFi.

## Libraries

* [Wasm3](https://github.com/wasm3/wasm3) ⭐ 7,978 | 🐛 66 | 🌐 C | 📅 2026-08-16 - A lightning fast WebAssembly interpreter designed for embedded devices, compatible with both ESP's.
* [IRremoteESP8266](https://github.com/markszabo/IRremoteESP8266) ⭐ 3,571 | 🐛 101 | 🌐 C++ | 📅 2026-08-14 - Emit and receive IR signals in the ESP8266.
* [ESPAudio](https://github.com/earlephilhower/ESP8266Audio) ⭐ 2,387 | 🐛 0 | 🌐 C | 📅 2026-08-02 - Library for playing a diverse range of audio formats in the ESP8266/ESP32.
...
* [HomeSpan](https://github.com/HomeSpan/HomeSpan) ⭐ 2,149 | 🐛 9 | 🌐 C++ | 📅 2026-08-18 - A robust and extremely easy-to-use Arduino library for creating your own ESP32-based HomeKit devices.
...
* [LedFx](https://github.com/LedFx/LedFx) ⭐ 2,020 | 🐛 16 | 🌐 Python | 📅 2026-08-17 - A library for using audio input to create realtime light shows. LedFx can control multiple devices and works great with cheap ESP8266 nodes.
* [ESP32-audioI2S](https://github.com/schreibfaul1/ESP32-audioI2S) ⭐ 1,669 | 🐛 31 | 🌐 C | 📅 2026-08-17 - Plays mp3, m4a and wav files from SD card or stream via I2S interface.
...
* [ESPUI](https://github.com/s00500/ESPUI) ⭐ 1,123 | 🐛 53 | 🌐 C++ | 📅 2026-04-30 - A simply library for making interactive web interfaces for both ESP's.
